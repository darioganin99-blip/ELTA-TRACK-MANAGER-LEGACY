...
const ELTA_APP_VERSION = "2.0.106";
...
/* ===== V2.0.106 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.106";
...
/* ===== V2.0.106 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.106 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.106 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function normalizeMenu(){
    const map=[['dash','🏠','Torre de Control'],['transitos','🚚','Tránsitos'],['entrega','🚛','Entregas'],['mapa','📍','Seguimiento'],['clima','🌦️','Clima'],['unidades','🚛','Unidades / Choferes'],['alertas','🔔','Alertas'],['clientes','🏢','Clientes / Destinos'],['abm','⚙️','Configuración']];
...
/* ===== V2.0.106 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.106 ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.106";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.106 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.106 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.106 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.106';
...
/* ===== V2.0.106 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.106 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.106 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.106';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.106';});
})();


/* ===== V2.0.106 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.106";
...
/* ===== V2.0.106 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.106";
...
/* ===== V2.0.106 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.106 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.106';
...
/* ===== V2.0.106 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.106';
...
/* ===== V2.0.106 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.106';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.106 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.106';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.106 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.106 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.106 - Entregas por flota, compacta y con aduanas por pais destino ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function ensureMenu(){
    ...
    btn.setAttribute('data-menu-id','entrega');
    ...
    const transito=buttons.find(b=>(b.getAttribute('onclick')||'').includes('transito'));
    const clima=buttons.find(b=>(b.getAttribute('onclick')||'').includes('clima'));
    if(transito && transito.nextSibling!==btn){nav.insertBefore(btn, transito.nextSibling);} 
    else if(!transito && clima && clima!==btn){nav.insertBefore(btn, clima);} 
  ...
  function carCarrier(cls=''){
    return `<span class="entregaCarrier ${cls}"><span>🚗</span><span>🚗</span><span>🚛</span></span>`;
  }
  function card(row){
  ...
  function injectCss(){
    ...
    css.textContent=`
      #entrega .entregaHeader{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px}.entregaRefreshBtn{height:38px;border-radius:10px;border:1px solid rgba(76,175,67,.72);background:#1d6d2f;color:#d8ffd0;font-weight:900;padding:0 18px}.entregaToolbar{display:grid;grid-template-columns:repeat(5,minmax(150px,1fr));gap:10px;padding:10px 12px;margin-bottom:12px}.entregaToolbar label{display:grid;grid-template-columns:auto 1fr;gap:8px;align-items:center;font-size:13px;font-weight:800;color:#dce6f1}.entregaToolbar select{height:34px;border-radius:9px;border:1px solid rgba(148,163,184,.30);background:#102033;color:#fff;padding:0 10px;font-weight:800;font-size:13px}.entregaCards{display:flex;flex-direction:column;gap:12px}.entregaCard{overflow:hidden;border:1px solid rgba(148,163,184,.24);background:linear-gradient(135deg,rgba(13,30,45,.97),rgba(8,20,33,.94));border-radius:16px;padding:14px 16px;box-shadow:0 12px 24px rgba(0,0,0,.22)}.entregaCard:nth-child(even){background:linear-gradient(135deg,rgba(18,37,54,.97),rgba(10,23,36,.94))}.entregaTop{display:grid;grid-template-columns:1.45fr repeat(4,1fr) .9fr;gap:12px;align-items:center}.entregaFleet{display:flex;align-items:center;gap:12px;min-width:0}.entregaFleetIcon{width:48px;height:48px;border-radius:50%;display:grid;place-items:center;background:rgba(32,156,48,.25);border:1px solid rgba(82,255,96,.42);font-size:22px}.entregaFleet h3{margin:0;font-size:23px;line-height:1;color:#f8fafc}.entregaFleet small{display:block;margin-top:6px;color:#cbd5e1;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.entregaStatus{display:inline-block;margin-top:7px;padding:5px 10px;border-radius:8px;font-size:12px;font-weight:900}.entregaStatus.open{background:#155d2d;color:#9dff7e}.entregaStatus.done{background:#475569;color:#e5e7eb}.entregaStatus.planned{background:#0b4a8f;color:#93c5fd}.entregaStatus.customs{background:#6b4e12;color:#fde68a}.entregaMeta{border-left:1px solid rgba(148,163,184,.20);padding-left:12px;min-width:0}.entregaMeta span{display:block;font-size:12px;color:#dbeafe;margin-bottom:5px}.entregaMeta b{display:block;color:#f8fafc;font-size:15px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.entregaMeta b.state.open{color:#7cff63}.entregaMeta b.state.done{color:#cbd5e1}.entregaMeta b.state.planned{color:#60a5fa}.entregaMeta b.state.customs{color:#fbbf24}.entregaFlags{border-left:1px solid rgba(148,163,184,.20);padding-left:14px;text-align:center;align-self:stretch;display:flex;flex-direction:column;justify-content:center}.flagLabelRow,.flagCodeRow{display:grid;grid-template-columns:1fr 1fr;gap:18px;color:#dbeafe;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.04em}.flagCodeRow{color:#f8fafc;font-size:13px;margin-top:4px}.flagRoute{display:flex;gap:13px;align-items:center;justify-content:center;margin:5px 0}.flagRoute i{font-style:normal;color:#7cff63;font-weight:900;font-size:28px;line-height:1}.flagRound{width:36px;height:36px;border-radius:50%;display:inline-block;border:2px solid rgba(255,255,255,.78);box-shadow:0 3px 8px rgba(0,0,0,.35);background:#64748b;position:relative;overflow:hidden}.flag-ar{background:linear-gradient(#8bd0ff 0 33%,#fff 33% 66%,#8bd0ff 66%)}.flag-ar:after{content:'';position:absolute;width:7px;height:7px;border-radius:50%;background:#f5b400;left:50%;top:50%;transform:translate(-50%,-50%)}.flag-cl{background:linear-gradient(#fff 0 50%,#e33434 50%)}.flag-cl:before{content:'★';position:absolute;left:0;top:0;width:50%;height:50%;background:#2451a6;color:#fff;font-size:9px;display:grid;place-items:center;line-height:1}.flag-py{background:linear-gradient(#d71920 0 33%,#fff 33% 66%,#2246a3 66%)}.flag-py:after{content:'';position:absolute;width:7px;height:7px;border-radius:50%;border:1px solid #c8a044;left:50%;top:50%;transform:translate(-50%,-50%);background:#fff}.flag-uy{background:repeating-linear-gradient(to bottom,#fff 0 5px,#4aa3df 5px 10px)}.flag-uy:before{content:'';position:absolute;left:0;top:0;width:16px;height:16px;background:#fff}.flag-uy:after{content:'';position:absolute;left:4px;top:4px;width:7px;height:7px;border-radius:50%;background:#f5b400}.entregaTimeline{position:relative;height:255px;margin-top:14px;padding:0 46px}.entregaLine{position:absolute;left:46px;right:46px;top:172px;height:5px;background:rgba(226,232,240,.78);border-radius:20px;overflow:visible;box-shadow:0 0 0 1px rgba(255,255,255,.10)}.entregaLine i{display:block;height:100%;background:linear-gradient(90deg,#22c55e,#84cc16,#f59e0b);border-radius:20px}.entregaStep{position:absolute;top:38px;transform:translateX(-50%);text-align:center;width:150px;min-height:126px;z-index:3}.entregaStep.first{transform:none;text-align:left}.entregaStep.last{transform:translateX(-100%);text-align:right}.entregaStep b{display:block;color:#f8fafc;font-size:14px;text-transform:none;line-height:1.15;white-space:normal;text-shadow:0 2px 5px rgba(0,0,0,.5)}.entregaStep em{display:block;margin-top:8px;color:#dbeafe;font-size:12px;font-style:normal;line-height:1.25}.entregaStep:before{content:'';position:absolute;left:50%;top:76px;height:84px;border-left:3px dotted rgba(226,232,240,.50);transform:translateX(-50%)}.entregaStep.first:before{left:0;transform:none}.entregaStep.last:before{left:auto;right:0;transform:none}.entregaStep::after{content:'';position:absolute;left:50%;top:126px;width:15px;height:15px;border-radius:50%;transform:translateX(-50%);border:3px solid #e2e8f0;background:#0b1b2b;box-shadow:0 0 0 3px rgba(11,27,43,.65)}.entregaStep.first::after{left:0;transform:none}.entregaStep.last::after{left:auto;right:0;transform:none}.entregaStep.done::after{border-color:#22c55e;background:#22c55e}.entregaStep.current::after{border-color:#f59e0b;background:#f59e0b;box-shadow:0 0 0 7px rgba(245,158,11,.18)}.entregaVehicle{position:absolute;top:105px;transform:translateX(-50%);z-index:4;filter:drop-shadow(0 10px 12px rgba(0,0,0,.55))}.entregaCarrier{display:block;width:185px;height:84px;background:url('assets/camion-automobilero.png') center/contain no-repeat}.entregaCarrier.customs{filter:hue-rotate(30deg) saturate(1.1)}.entregaCarrier.planned{filter:hue-rotate(155deg)}.entregaBottom{display:grid;grid-template-columns:1.1fr 1.1fr 1.1fr .8fr;gap:8px;margin-top:4px;padding:10px 12px;border-radius:12px;background:rgba(255,255,255,.035);border:1px solid rgba(148,163,184,.12);color:#dbeafe;font-size:13px}.entregaBottom span{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.entregaBottom b{color:#9dff7e}.entregaEmpty{padding:20px;color:#cbd5e1;font-weight:800}@media(max-width:1250px){.entregaToolbar{grid-template-columns:1fr 1fr}.entregaTop{grid-template-columns:1fr 1fr}.entregaBottom{grid-template-columns:1fr}.entregaTimeline{overflow:hidden}.entregaFlags{border-left:0;padding-left:0}.entregaCarrier{width:150px}}    `; document.head.appendChild(css);
  }
...
/* ===== V2.0.106 - Restauracion robusta del menu Entregas ===== */
(function(){
  const VERSION='2.0.106';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function findBtn(nav,id){
    return nav.querySelector('button[data-menu-id="'+id+'"]') || nav.querySelector('button[onclick*="'+id+'"]');
  }
  function normalizeMenu104(){
    const nav=document.querySelector('.sideNav'); if(!nav) return;
    const currentActive=(nav.querySelector('button.active')?.getAttribute('onclick')||'').match(/tab\('([^']+)'\)/)?.[1];
    MENU_ORDER.forEach(([id,icon,text])=>{
      let btn=findBtn(nav,id);
      if(!btn){btn=document.createElement('button'); btn.type='button';}
      btn.setAttribute('onclick',"tab('"+id+"')");
      btn.setAttribute('data-menu-id',id);
      btn.title=text;
      btn.innerHTML='<span class="menuIcon" aria-hidden="true">'+icon+'</span><span class="menuText">'+text+'</span>';
      nav.appendChild(btn);
      btn.classList.toggle('active', currentActive ? currentActive===id : btn.classList.contains('active'));
    });
  }
  function apply104(){setVersion104(); normalizeMenu104();}
  document.addEventListener('DOMContentLoaded',()=>{apply104(); setTimeout(apply104,100); setTimeout(apply104,700);});
  window.addEventListener('load',()=>{apply104(); setTimeout(apply104,300);});
  const oldTab104=window.tab;
  window.tab=function(id){
    if(typeof oldTab104==='function') oldTab104.apply(this,arguments);
    document.querySelectorAll('.sideNav button').forEach(b=>b.classList.remove('active'));
    document.querySelector('.sideNav button[data-menu-id="'+id+'"]')?.classList.add('active');
    if(id==='entrega' && typeof window.renderEntrega==='function') setTimeout(()=>window.renderEntrega(false),20);
    apply104();
  };
  const oldToggle104=window.toggleSidebar;
  window.toggleSidebar=function(){
    if(typeof oldToggle104==='function') oldToggle104.apply(this,arguments); else document.body.classList.toggle('sidebarCollapsed');
    setTimeout(apply104,0);
  };
})();


/* ===== V2.0.106 - FIX REAL menu Entregas sin tocar el resto ===== */
function ensureEntrega(){
  try{
    var nav=document.querySelector('.sideNav');
    if(nav){
      var btn=nav.querySelector('button[data-menu-id="entrega"]') || Array.from(nav.querySelectorAll('button')).find(function(b){return String(b.getAttribute('onclick')||'').indexOf("tab('entrega')")>=0 || String(b.textContent||'').toLowerCase().indexOf('entregas')>=0;});
      if(!btn){
        ...
        var trans=Array.from(nav.querySelectorAll('button')).find(function(b){return String(b.getAttribute('onclick')||'').indexOf('transitos')>=0 || String(b.textContent||'').toLowerCase().indexOf('tránsito')>=0 || String(b.textContent||'').toLowerCase().indexOf('transito')>=0;});
        if(trans && trans.nextSibling) nav.insertBefore(btn, trans.nextSibling); else nav.appendChild(btn);
      }else{
        btn.setAttribute('data-menu-id','entrega');
        btn.setAttribute('onclick',"tab('entrega')");
        btn.title='Entregas';
        btn.innerHTML='<span class="menuIcon" aria-hidden="true">🚛</span><span class="menuText">Entregas</span>';
        var trans2=Array.from(nav.querySelectorAll('button')).find(function(b){return b!==btn && (String(b.getAttribute('onclick')||'').indexOf('transitos')>=0 || String(b.textContent||'').toLowerCase().indexOf('tránsito')>=0 || String(b.textContent||'').toLowerCase().indexOf('transito')>=0);});
        if(trans2 && trans2.nextSibling!==btn) nav.insertBefore(btn, trans2.nextSibling);
      }
    }
    if(!document.getElementById('entrega')){
      ...
      sec.innerHTML='<div class="sectionTitle entregaHeader"><div><h2>Entregas</h2><p>Seguimiento de flotas en tránsito</p></div><button type="button" class="entregaRefreshBtn" onclick="window.renderEntrega && window.renderEntrega(true)">Actualizar</button></div><div class="entregaToolbar glassPanel"><label>Cliente<select id="entregaFiltroCliente"><option value="">Todos</option></select></label><label>Embarque<select id="entregaFiltroEmbarque"><option value="">Todos</option></select></label><label>Destino<select id="entregaFiltroDestino"><option value="">Todos</option></select></label><label>Flota<select id="entregaFiltroFlota"><option value="">Todos</option></select></label><label>Estado<select id="entregaFiltroEstado"><option value="">Todos</option><option>EN TRÁNSITO</option><option>EN ADUANA</option><option>PROGRAMADO</option><option>FINALIZADO</option></select></label></div><div id="entregaCards" class="entregaCards"></div>';
      var main=document.querySelector('.dashboardShell') || document.querySelector('main');
      var emb=document.getElementById('embarques');
      if(emb && emb.parentNode) emb.parentNode.insertBefore(sec, emb); else if(main) main.appendChild(sec);
    }
  }catch(e){console.warn('ensureEntrega v2.0.106',e);}
}
window.ensureEntrega=ensureEntrega;
(function(){
  var previousTab=window.tab;
  window.tab=function(id){
    try{ ensureEntrega(); }catch(e){}
    try{
      if(typeof previousTab==='function') previousTab.apply(this,arguments);
    }catch(e){
      console.warn('tab anterior falló, usando fallback v2.0.106',e);
      ...
      var btn=document.querySelector('.sideNav button[data-menu-id="'+id+'"]') || document.querySelector('.sideNav button[onclick*="'+id+'"]');
      if(btn) btn.classList.add('active');
    }
    if(id==='entrega' && typeof window.renderEntrega==='function') setTimeout(function(){try{window.renderEntrega(false);}catch(e){console.warn(e);}},40);
  };
  function apply(){ensureEntrega();
    document.querySelectorAll('span,small,p,div').forEach(function(el){if(el.childElementCount===0 && /Versi[oó]n\s+\d+\.\d+\.\d+/.test(el.textContent||'')){el.textContent=(el.textContent||'').replace(/Versi[oó]n\s+\d+\.\d+\.\d+/g,'Versión 2.0.106');}});
  }
  document.addEventListener('DOMContentLoaded',function(){apply(); setTimeout(apply,100); setTimeout(apply,600);});
  window.addEventListener('load',function(){apply(); setTimeout(apply,500);});
})();


/* ===== V2.0.106 - MENU OFICIAL RESTAURADO + ENTREGAS FIJO ===== */
(function(){
  const MENU_OFICIAL = [
    ['dash','🏠','Torre de Control'],
    ['mapa','📍','Seguimiento'],
  ...
  function renderMenu(){
    ...
    nav.innerHTML = MENU_OFICIAL.map(([id,ic,txt]) =>
      `<button type="button" onclick="tab('${id}')" data-menu-id="${id}" class="${id===current?'active':''}"><span class="menuIcon">${ic}</span><span class="menuText">${txt}</span></button>`
    ).join('');
  }
  function ensureEntregaPanel(){
    if(document.getElementById('entrega')) return;
    const ref=document.getElementById('transitos') || document.querySelector('main.dashboardShell .panel:last-of-type');
    if(!ref || !ref.parentNode) return;
    const sec=document.createElement('section');
    sec.id='entrega';
    sec.className='panel';
    sec.innerHTML=`<div class="sectionTitle"><h2>Entregas</h2><p>Seguimiento de embarques y entregas</p></div><div id="entregaCards" class="entregaCards"></div>`;
    ref.insertAdjacentElement('afterend',sec);
  }
  function setVersion106(){
    document.querySelectorAll('footer span,.headerTitle span').forEach(el=>{
      if(/Versi[oó]n/i.test(el.textContent||'')) el.textContent='Versión 2.0.106';
    });
  }
  function applyMenu(){ ensureEntregaPanel(); renderMenu(); setVersion106(); }
  const previousTab = window.tab;
  window.tab = function(id){
    ensureEntregaPanel();
    let result;
    if(typeof previousTab === 'function') result = previousTab.apply(this, arguments);
    else {
      document.querySelectorAll('.panel').forEach(p=>p.classList.remove('active'));
      document.getElementById(id)?.classList.add('active');
    }
    setTimeout(()=>{ applyMenu(); if(id==='entrega' && typeof window.renderEntrega==='function') window.renderEntrega(false); },0);
    setTimeout(applyMenu,80);
    return result;
  };
  document.addEventListener('DOMContentLoaded',()=>{applyMenu(); setTimeout(applyMenu,150); setTimeout(applyMenu,700);});
  window.addEventListener('load',()=>{applyMenu(); setTimeout(applyMenu,300); setTimeout(applyMenu,1200);});
  setTimeout(applyMenu,2000);
})();
