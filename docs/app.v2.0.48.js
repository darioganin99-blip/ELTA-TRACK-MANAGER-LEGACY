...
/* ===== V2.0.48 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.48";
...
/* ===== V2.0.48 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.48 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.48 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.48 ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.48";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.48 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.48 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.48 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.48';
...
/* ===== V2.0.48 - Normalizacion definitiva SOLO menu lateral ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Fix definitivo menú lateral, hamburguesa y campana sin contador ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.48 - Embarques: filtro por fecha robusto (dd/mm, ISO, datetime-local) ===== */
(function(){
  const VERSION='2.0.48';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  const L=(v)=>String(v||'').toLowerCase().trim();
  const U=(arr)=>[...new Set((arr||[]).map(v=>String(v||'').trim()).filter(Boolean))].sort((a,b)=>a.localeCompare(b,'es',{numeric:true}));
  const data=(name)=>{try{if(name==='clientes')return Array.isArray(clientes)?clientes:[];if(name==='origenes')return Array.isArray(origenes)?origenes:[];if(name==='destinos')return Array.isArray(destinos)?destinos:[];if(name==='embarques')return Array.isArray(embarques)?embarques:[];if(name==='trs')return Array.isArray(trs)?trs:[];if(name==='users')return Array.isArray(users)?users:[];}catch(e){} return Array.isArray(window[name])?window[name]:[];};
  const nameFromDoc=(x,kind)=>{if(!x)return '';if(typeof x==='string')return x;const docId=String(x.id||'').trim();if(docId)return docId;if(kind==='cliente')return x.nombre||x.name||x.cliente||x.razonSocial||x.razon_social||x.descripcion||'';if(kind==='origen')return x.nombre||x.name||x.origen||x.descripcion||'';if(kind==='destino')return x.nombre||x.name||x.destino||x.descripcion||'';return x.nombre||x.name||'';};
  const route=(t)=>{try{return (typeof ruta==='function'?ruta(t):t.route)||{};}catch(e){return t?.route||{};}};
  const fleet=(t)=>{try{return String(typeof flota==='function'?flota(t):(t?.flota||t?.user?.fleet||'')).trim();}catch(e){return String(t?.flota||t?.user?.fleet||'').trim();}};
  const fmt=(v)=>{try{return typeof fd==='function'?fd(v):S(v);}catch(e){return S(v);}};
  const embNumber=(e)=>String(e?.numero||e?.embarque||e?.id||e?.codigo||'').trim();
  ...
  function normalizeDate(value, endOfDay=false){
    ...
    try{
      ...
      if(!s) return null;
      // datetime-local: 2026-06-13T11:02 o fecha ISO
      let iso=s.match(/^(\d{4})-(\d{2})-(\d{2})(?:[T\s](\d{1,2}):(\d{2}))?/);
      if(iso){
        let d=new Date(+iso[1],+iso[2]-1,+iso[3], iso[4]?+iso[4]:(endOfDay?23:0), iso[5]?+iso[5]:(endOfDay?59:0), endOfDay?59:0, endOfDay?999:0);
        return isNaN(d)?null:d;
      }
      // formato app: 13/6, 11:02 p. m. / 13/06/2026 11:02 / 13/6, 05:08 p. m.
      let m=s.match(/(\d{1,2})\/(\d{1,2})(?:\/(\d{2,4}))?(?:[^0-9]*(\d{1,2}):(\d{2}))?\s*(a\.?\s*m\.?|p\.?\s*m\.?)?/i);
      if(m){
        let day=+m[1], mon=+m[2]-1, year=m[3]?+m[3]:(new Date()).getFullYear();
        if(year<100) year+=2000;
        let hh=m[4]?+m[4]:(endOfDay?23:0), mm=m[5]?+m[5]:(endOfDay?59:0);
        let ampm=(m[6]||'').toLowerCase().replace(/\s/g,'');
        if(ampm.includes('p') && hh<12) hh+=12;
        if(ampm.includes('a') && hh===12) hh=0;
        let d=new Date(year,mon,day,hh,mm,endOfDay?59:0,endOfDay?999:0);
        return isNaN(d)?null:d;
      }
      let d=new Date(s);
      return isNaN(d)?null:d;
  ...
  function inDateRange(v,from,to){
    ...
    const d=normalizeDate(v,false);
    if(!d) return false;
    const f=from?normalizeDate(from,false):null;
    const t=to?normalizeDate(to,true):null;
    return (!f || d>=f) && (!t || d<=t);
  }

  function optionHtml(list,placeholder='Seleccionar'){return `<option value="">${E(placeholder)}</option>`+(list||[]).map(v=>`<option value="${E(v)}">${E(v)}</option>`).join('');}
  function fillSelect(id,list,placeholder){const el=$id(id); if(!el) return; const cur=el.value; el.innerHTML=optionHtml(list,placeholder); if([...el.options].some(o=>o.value===cur)) el.value=cur;}
  function lists(){const cliCat=U(data('clientes').map(x=>nameFromDoc(x,'cliente')));const oriCat=U(data('origenes').map(x=>nameFromDoc(x,'origen')));const desCat=U(data('destinos').map(x=>nameFromDoc(x,'destino')));return {cli:cliCat.length?cliCat:U(data('trs').map(t=>route(t).cliente)),ori:oriCat.length?oriCat:U(data('trs').map(t=>route(t).origen)),des:desCat.length?desCat:U(data('trs').map(t=>route(t).destino))};}
  function cargas(){try{return JSON.parse(localStorage.getItem('elta_cargas_embarque_v245')||localStorage.getItem('elta_cargas_embarque_v244')||'[]')||[];}catch(e){return []}}
  function build(){
    const map=new Map();
    data('embarques').forEach(e=>{const n=embNumber(e); if(!n)return; map.set(n,{numero:n,cliente:e.cliente||'',origen:e.origen||'',destino:e.destino||'',fecha:e.fecha||e.fechaHora||e.createdAt||e.updatedAt||'',activo:e.activo!==false,flotas:new Set(),source:e});});
    data('trs').forEach(t=>{const n=String(t?.embarque||t?.emb||t?.embarqueNumero||t?.embarqueId||'').trim(); if(!n)return; const r=route(t); if(!map.has(n))map.set(n,{numero:n,cliente:r.cliente||'',origen:r.origen||'',destino:r.destino||'',fecha:t?.fecha||t?.createdAt||t?.start?.time||t?.start||'',activo:true,flotas:new Set(),source:null}); const it=map.get(n); it.cliente=it.cliente||r.cliente||''; it.origen=it.origen||r.origen||''; it.destino=it.destino||r.destino||''; it.fecha=it.fecha||t?.start?.time||t?.start||''; const f=fleet(t); if(f)it.flotas.add(f);});
    cargas().forEach(c=>{const n=String(c?.embarque||'').trim(); if(!n)return; if(!map.has(n))map.set(n,{numero:n,cliente:'',origen:'',destino:'',fecha:c.createdAt||'',activo:true,flotas:new Set(),source:null}); const f=String(c?.flota||'').trim(); if(f)map.get(n).flotas.add(f);});
    return [...map.values()].sort((a,b)=>String(b.numero).localeCompare(String(a.numero),'es',{numeric:true}));
  }
  async function ensureData(){try{if(typeof read==='function' && (!data('clientes').length || !data('origenes').length || !data('destinos').length || !data('embarques').length)){[trs,users,clientes,origenes,destinos,embarques]=await Promise.all([read('transitos'),read('usuarios'),read('clientes'),read('origenes'),read('destinos'),read('embarque')]);}}catch(e){console.warn('No se pudieron cargar datos de embarques',e);}}

  window.renderEmbarquesV244=async function(){
    await ensureData();
    const {cli,ori,des}=lists();
    fillSelect('embFilterCliente',cli,'Todos los clientes'); fillSelect('embFilterOrigen',ori,'Todos los orígenes'); fillSelect('embFilterDestino',des,'Todos los destinos');
    fillSelect('embCliente',cli,'Seleccionar cliente'); fillSelect('embOrigen',ori,'Seleccionar origen'); fillSelect('embDestino',des,'Seleccionar destino');
    const fc=L($id('embFilterCliente')?.value), fo=L($id('embFilterOrigen')?.value), fdest=L($id('embFilterDestino')?.value);
    const desde=$id('embFilterDesde')?.value||'', hasta=$id('embFilterHasta')?.value||'';
    const rows=build().filter(e=>(!fc||L(e.cliente)===fc)&&(!fo||L(e.origen)===fo)&&(!fdest||L(e.destino)===fdest)&&inDateRange(e.fecha,desde,hasta));
    const cgs=cargas(), tbody=$id('embarquesTbody');
    if(tbody){tbody.innerHTML=rows.map(e=>{const c=cgs.filter(x=>String(x.embarque)===String(e.numero)).length;return `<tr><td><b>Emb. ${E(e.numero)}</b></td><td>${E(S(e.cliente))}</td><td>${E(S(e.origen))}</td><td>${E(S(e.destino))}</td><td>${E(fmt(e.fecha))}</td><td>${E([...e.flotas].join(', ')||'-')}</td><td>${c}</td><td><button class="iconBtn view" onclick="window.openEmbarqueDetailV244('${E(e.numero)}')">👁️</button><button class="iconBtn edit" onclick="window.openCargoFormV244('${E(e.numero)}')">+ Carga</button></td></tr>`;}).join('') || '<tr><td colspan="8" class="emptyRow">No hay embarques para mostrar.</td></tr>';}
  };

  window.resetEmbarqueFiltersV244=function(){['embFilterCliente','embFilterOrigen','embFilterDestino','embFilterDesde','embFilterHasta'].forEach(id=>{const e=$id(id); if(e)e.value='';}); window.renderEmbarquesV244();};
  ['DOMContentLoaded','load'].forEach(ev=>window.addEventListener(ev,()=>setTimeout(()=>window.renderEmbarquesV244(),700)));
})();
