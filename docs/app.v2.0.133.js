...
(function(){
  ...
  function patchMenuConstant(){ /* disabled: no wrapping de window.tab para evitar doble render de Entregas */ }
...
(function(){
  ...
  /* disabled: no wrapping de window.tab para evitar inestabilidad en Entregas */
...
(function(){
  ...
  /* disabled: no wrapping de window.tab para evitar doble vista/refresco en Entregas */
