...
const ELTA_APP_VERSION='2.0.179';
...
/* ===== V2.0.179 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2='2.0.179';
...
/* ===== V2.0.179 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='2.0.179';
...
/* ===== V2.0.179 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.179 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.179 ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.179";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.179 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.179 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.179 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2173 = '2.0.179';
...
/* ===== V2.0.179 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.179 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.179 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.179';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.179';});
})();


/* ===== V2.0.179 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.179";
...
/* ===== V2.0.179 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.179";
...
/* ===== V2.0.179 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.179 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.179';
...
/* ===== V2.0.179 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.179';
...
/* ===== V2.0.179 - Version lock definitivo ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.179 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.179';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.179 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.179 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.179 - ENTREGAS: ROUTING UNICO SIN REFRESH ===== */
(function(){
  'use strict';
  const VERSION='2.0.179';
  window.ELTA_APP_VERSION=VERSION;
...
/* ===== v2.0.179 - CSS final linea desde circulo Entregas ===== */
(function(){
  const CSS = '\n/* ===== v2.0.179 - Entregas: linea vertical nace desde el circulo =====\n   SOLO afecta la vista #entrega. No modifica icono de camion ni otros modulos. */\n\n#entrega .entregaStep.hasDate::before{\n  content:"" !important;\n  position:absolute !important;\n  left:50% !important;\n  top:32px !important;\n  height:33px !important;\n  border-left:2px dotted rgba(226,232,240,.72) !important;\n  transform:translateX(-50%) !important;\n  z-index:2 !important;\n}\n\n#entrega .entregaStep::after{\n  top:65px !important;\n  z-index:4 !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:0%"]::before{\n  left:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:100%"]::before{\n  left:auto !important;\n  right:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep:not(.hasDate)::before{\n  content:none !important;\n  display:none !important;\n}\n';
...
/* ===== v2.0.179 - Entregas: avance por registros + bandera Tierra del Fuego =====
...
/* ===== v2.0.179 - Entregas: timeline por registros reales corregido =====
   Solo afecta la vista Entregas. No modifica diseño ni otros módulos. */
(function(){
  const CSS = `
/* ===== v2.0.179 - Entregas: extremos y registros reales =====
...
/* ===== v2.0.179 - Entregas: hitos desde Aduanas + camión por último registro ===== */
(function(){
const CSS=`
/* v2.0.179 - Entregas: aduanas y avance real */
...
/* ===== v2.0.179 - Entregas: abreviatura visual de hitos =====
...
/* ===== v2.0.179 - Entregas: hitos desde colección aduana por campo destino =====
...
/* ===== v2.0.179 - Entregas: botón Actualizar refresca timeline =====
...
/* ===== v2.0.179 - Entregas: Actualizar reconstruye la línea como al reingresar =====
   Solo afecta el botón Actualizar de Entregas. No modifica estética ni otros módulos. */
(function(){
...
/* ===== v2.0.179 - Entregas: Actualizar sin parpadeo =====
...
/* ===== v2.0.179 - Entregas: Actualizar in-place sin reconstruir tarjeta =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v2.0.179 - Entregas: Actualizar aislado, sin render viejo =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v2.0.179 - Version final + Entregas boton aislado dominante ===== */
(function(){
  const VERSION_FINAL_173 = '2.0.179';
...
/* ===== v2.0.179 - Reporte PDF: hitos desde colección aduana =====
...
/* ===== v2.0.179 - Forzado final de versión visible y PDF ===== */
(function(){
  const VERSION_FINAL_177 = '2.0.179';
...
/* ===== v2.0.179 - Alertas: eliminar render heredado de KM =====
   Solo afecta el menu Alertas. No cambia estetica, logica ni otros modulos. */
(function(){
  const VERSION_ALERTAS_179 = '2.0.179';
  window.ELTA_APP_VERSION = VERSION_ALERTAS_179;
  window.APP_VERSION_V2 = VERSION_ALERTAS_179;

  function setVersion179(){
    document.querySelectorAll('span,small,p,div').forEach(el=>{
      if(el.childElementCount===0 && /Versi[oó]n\s+\d+\.\d+\.\d+/.test(el.textContent||'')){
        el.textContent=(el.textContent||'').replace(/Versi[oó]n\s+\d+\.\d+\.\d+/g,'Versión '+VERSION_ALERTAS_179);
      }
    });
  }

  function removeKmFromAlertas179(){
    const root=document.getElementById('alertas');
    if(!root) return;

    root.querySelectorAll('th,td,div,b,span').forEach(el=>{
      const txt=(el.textContent||'').trim().toLowerCase();
      if(txt==='km' || txt==='km:'){
        const tr=el.closest('tr');
        if(tr && el.closest('table')){
          const cell=el.closest('th,td');
          const idx=cell ? cell.cellIndex : -1;
          ...
          if(row && row.textContent && /^\s*km\s*:/i.test(row.textContent)) row.remove();
        }
      }
    });

    root.querySelectorAll('.alertItemMeta > div').forEach(div=>{
      if(/^\s*km\s*:/i.test((div.textContent||'').trim())) div.remove();
    });
  }

  const oldRenderAlerts179 = window.renderAlerts || (typeof renderAlerts==='function' ? renderAlerts : null);
  if(typeof oldRenderAlerts179==='function' && !oldRenderAlerts179.__noKm179){
    const wrapped=function(){
      const r=oldRenderAlerts179.apply(this,arguments);
      removeKmFromAlertas179();
      setVersion179();
      return r;
    };
    wrapped.__noKm179=true;
    window.renderAlerts=wrapped;
    try{ renderAlerts=wrapped; }catch(e){}
  }

  const oldTab179=window.tab;
  if(typeof oldTab179==='function' && !oldTab179.__alertasNoKm179){
    window.tab=function(id){
      const r=oldTab179.apply(this,arguments);
      if(id==='alertas'){
        setTimeout(removeKmFromAlertas179,0);
        setTimeout(removeKmFromAlertas179,80);
        setTimeout(removeKmFromAlertas179,180);
      }
      setVersion179();
      return r;
    };
    window.tab.__alertasNoKm179=true;
  }

  document.addEventListener('DOMContentLoaded',()=>{setVersion179(); removeKmFromAlertas179();});
  window.addEventListener('load',()=>{setVersion179(); removeKmFromAlertas179();});
  setInterval(()=>{ if(document.getElementById('alertas')?.classList.contains('active')) removeKmFromAlertas179(); }, 500);
})();
