...
const ELTA_APP_VERSION = "2.0.137";
...
/* ===== V2.0.137 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.137";
...
/* ===== V2.0.137 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.137 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.137 ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.137";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.137 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.137 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.137 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.137';
...
/* ===== V2.0.137 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.137 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.137 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.137';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.137';});
})();


/* ===== V2.0.137 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.137";
...
/* ===== V2.0.137 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.137";
...
/* ===== V2.0.137 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.137 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.137';
...
/* ===== V2.0.137 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.137';
...
/* ===== V2.0.137 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.137';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.137 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.137';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.137 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.137 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Entrega por flota, compacta y con aduanas por pais destino ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - Entrega: flota, banderas por pais, aduanas por destino, compacto ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - ajuste final SOLO Entregas: menú estable, timeline sin superposición ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
  function setV(){
...
/* ===== V2.0.137 - FIX FINAL VERSION Y MENU ESTABLE ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - SOLO ENTREGAS: icono único y tarjeta según boceto ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - SOLO ENTREGAS: tarjeta compacta, camion reducido, banderas icono ===== */
(function(){
  const VERSION='2.0.137';
  function applyVersion(){
    window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO ENTREGAS: tarjeta igual al boceto, hitos sobre linea, camion chico, banderas reales ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - SOLO ENTREGAS: tarjeta reconstruida igual boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.137';
  function setVer(){
...
/* ===== V2.0.137 - CORRECCION FINAL SOLO ENTREGAS: tarjeta igual al boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO Entregas: tarjeta compacta final y 2 banderas reales ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO Entregas: contenedor compacto, hitos sobre linea, sin checks, 2 banderas ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - SOLO Entregas: correccion real tarjeta compacta, banderas y timeline ===== */
(function(){
  const VERSION='2.0.137';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.137 - FIX FINAL SOLO ENTREGAS: banderas reales + iconos cabecera, sin tocar menu ni Embarques ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - FIX FINAL SOLO ENTREGAS: version unica + banderas reales visibles ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - FIX DEFINITIVO SOLO ENTREGAS: banderas reales dinamicas + version estable ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - SOLO ENTREGAS: banderas reales y contenedores alternados ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - FIX FINAL SOLO ENTREGAS: banderas visibles, version estable, contenedor alternado ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - FIX REAL SOLO ENTREGAS: banderas origen/destino + segundo contenedor mas claro ===== */
(function(){
  const VERSION='2.0.137';
...
/* ===== V2.0.137 - SOLO ENTREGAS: filtros compactos y estables ===== */
(function(){
  const VERSION='2.0.137';
  function setVersion(){
...
/* ===== V2.0.137 - FIX REAL: Entregas sin doble icono ni refresh, sin tocar inicio/tarjetas/filtros ===== */
(function(){
  'use strict';
  const VERSION='2.0.137';
  const ENTREGA_ICON='🚛';
  let internal=false;
  function setVersion137(){
    try{
      window.ELTA_APP_VERSION=VERSION;
      window.APP_VERSION_V2=VERSION;
      document.title='ELTA ITS - Versión '+VERSION;
  ...
  function getNav(){return document.querySelector('.sideNav');}
  function isEntregaBtn(b){
    if(!b) return false;
    const oc=String(b.getAttribute('onclick')||'');
    const tx=String(b.textContent||'').trim().toLowerCase();
    return (b.dataset && b.dataset.menuId==='entrega') || oc.indexOf('entrega')>=0 || tx==='entregas';
  }
  function setEntregaButton(btn){
    if(!btn) return;
    btn.type='button';
    ...
    ic.textContent=ENTREGA_ICON;
    tx.textContent='Entregas';
  }
  function normalizeEntregaMenu137(){
    if(internal) return;
    const nav=getNav(); if(!nav) return;
    internal=true;
    try{
      const buttons=[].slice.call(nav.querySelectorAll('button'));
      let entregaBtns=buttons.filter(isEntregaBtn);
      let emb=[].slice.call(nav.querySelectorAll('button')).find(function(b){return String(b.getAttribute('onclick')||'').indexOf('embarques')>=0 || String(b.textContent||'').trim().toLowerCase()==='embarques';});
      let keep=entregaBtns[0];
      if(!keep){
        keep=document.createElement('button');
        if(emb) emb.insertAdjacentElement('afterend',keep); else nav.appendChild(keep);
      }
      entregaBtns.forEach(function(b){if(b!==keep) b.remove();});
      setEntregaButton(keep);
      if(emb && emb.nextElementSibling!==keep) emb.insertAdjacentElement('afterend',keep);
      setEntregaButton(keep);
  ...
  function activatePanel(id){
    ...
    const nav=getNav();
    if(nav){
      const btn=[].slice.call(nav.querySelectorAll('button')).find(function(b){
        const oc=String(b.getAttribute('onclick')||'');
        return (id==='entrega' && isEntregaBtn(b)) || oc.indexOf("'"+id+"'")>=0 || oc.indexOf('"'+id+'"')>=0 || oc.indexOf(id)>=0;
      });
  ...
  function ensureEntregaRenderedOnce(){
    if(typeof window.renderEntrega==='function'){
      try{ window.renderEntrega(false); }catch(e){ console.warn('renderEntrega',e); }
    }
  }
  const chainedTab=window.tab;
  if(typeof chainedTab==='function' && !chainedTab.__entregaStable137){
    const stableTab=function(id){
      id=String(id||'');
      normalizeEntregaMenu137();
      setVersion137();
      if(id==='entrega'){
        const panel=document.getElementById('entrega');
        const already=panel && panel.classList.contains('active');
        activatePanel('entrega');
        if(!already || !panel || !panel.querySelector('#entregaCards')) ensureEntregaRenderedOnce();
        setTimeout(function(){normalizeEntregaMenu137();setVersion137();},0);
        return false;
      }
      return chainedTab.apply(this,arguments);
    };
    stableTab.__entregaStable137=true;
    window.tab=stableTab;
  }
  function injectCss137(){
    if(document.getElementById('fix-entrega-menu-137-css')) return;
    const st=document.createElement('style');
    st.id='fix-entrega-menu-137-css';
    st.textContent=`
      .sideNav button[data-menu-id="entrega"] .menuIcon,
      .sideNav button[onclick*="entrega"] .menuIcon{font-size:0!important;line-height:1!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-width:24px!important;}
      .sideNav button[data-menu-id="entrega"] .menuIcon:before,
      .sideNav button[onclick*="entrega"] .menuIcon:before{content:'${ENTREGA_ICON}'!important;font-size:22px!important;line-height:1!important;}
      #embarques .darkTable table td,#embarques .darkTable table th{padding-top:8px!important;padding-bottom:8px!important;font-size:13px!important;}
      #embarques .darkTable .btn,#embarques button{min-height:34px;}
    `;
    document.head.appendChild(st);
  }
  function boot137(){injectCss137();normalizeEntregaMenu137();setVersion137();}
  if(document.readyState==='loading') document.addEventListener('DOMContentLoaded',boot137); else boot137();
  window.addEventListener('load',function(){boot137();setTimeout(boot137,250);});
  const nav=getNav();
  const obs=new MutationObserver(function(){ if(!internal) requestAnimationFrame(boot137); });
  function startObs(){const n=getNav(); if(n) obs.observe(n,{childList:true,subtree:true,characterData:true});}
