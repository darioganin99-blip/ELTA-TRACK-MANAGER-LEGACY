...
/* ===== V2.0.42 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.42";
...
/* ===== V2.0.42 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.42 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.42 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.42 ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.42";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.42 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.42 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.42 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.42';
...
/* ===== V2.0.42 - Normalizacion definitiva SOLO menu lateral ===== */
(function(){
  const VERSION='2.0.42';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.42 - Blindaje final menu/version ===== */
(function(){
  const VERSION='2.0.42';
  function setVersion(){
    document.querySelectorAll('span,small,p,div').forEach(el=>{
  ...
  function normalizeMenu(){
    ...
    if(sidebar){ sidebar.style.width='300px'; sidebar.style.minWidth='300px'; sidebar.style.maxWidth='300px'; }
    if(shell){ shell.style.marginLeft='300px'; shell.style.width='calc(100vw - 300px)'; shell.style.maxWidth='calc(100vw - 300px)'; }
    const labels={dash:'Torre de Control',transitos:'Tránsitos',mapa:'Seguimiento',clima:'Clima',unidades:'Unidades / Choferes',alertas:'Alertas',clientes:'Clientes / Destinos',abm:'Configuración'};
    Object.entries(labels).forEach(([id,txt])=>{
      const btn=document.querySelector(`.sideNav button[onclick*="${id}"]`);
      if(!btn) return;
      let t=btn.querySelector('.menuText');
      if(!t){ t=document.createElement('span'); t.className='menuText'; btn.appendChild(t); }
      t.textContent=txt;
      t.style.whiteSpace='nowrap'; t.style.overflow='visible'; t.style.textOverflow='clip';
    });
    const alertBtn=document.querySelector('.sideNav button[onclick*="alertas"]');
    const h=document.getElementById('headerAlertCount');
    const n=parseInt((h&&h.textContent)||'0',10)||0;
    if(alertBtn){
      let badge=alertBtn.querySelector('.sideAlertBadge');
      if(n>0){ if(!badge){badge=document.createElement('span'); badge.className='sideAlertBadge'; alertBtn.appendChild(badge);} badge.textContent=String(n); }
  ...
  window.toggleSidebar=function(){
    ...
    setTimeout(normalizeMenu,30);
    if(typeof oldToggle==='function') try{ oldToggle(); }catch(e){}
    setTimeout(normalizeMenu,80);
  };
  ['DOMContentLoaded','load'].forEach(ev=>window.addEventListener(ev,()=>{setVersion();normalizeMenu();setTimeout(normalizeMenu,400);setTimeout(normalizeMenu,1200);}));
  setInterval(()=>{setVersion();normalizeMenu();},2500);
})();
