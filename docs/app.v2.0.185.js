...
const ELTA_APP_VERSION='2.0.185';
...
/* ===== V2.0.185 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2='2.0.185';
...
/* ===== V2.0.185 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='2.0.185';
...
/* ===== V2.0.185 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.185 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.185 ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.185";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.185 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.185 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.185 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2173 = '2.0.185';
...
/* ===== V2.0.185 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.185 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.185 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.185';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.185';});
})();


/* ===== V2.0.185 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.185";
...
/* ===== V2.0.185 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.185";
...
/* ===== V2.0.185 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.185 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.185';
...
/* ===== V2.0.185 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.185';
...
/* ===== V2.0.185 - Version lock definitivo ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.185 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.185';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.185 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.185 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.185 - ENTREGAS: ROUTING UNICO SIN REFRESH ===== */
(function(){
  'use strict';
  const VERSION='2.0.185';
  window.ELTA_APP_VERSION=VERSION;
...
/* ===== v2.0.185 - CSS final linea desde circulo Entregas ===== */
(function(){
  const CSS = '\n/* ===== v2.0.185 - Entregas: linea vertical nace desde el circulo =====\n   SOLO afecta la vista #entrega. No modifica icono de camion ni otros modulos. */\n\n#entrega .entregaStep.hasDate::before{\n  content:"" !important;\n  position:absolute !important;\n  left:50% !important;\n  top:32px !important;\n  height:33px !important;\n  border-left:2px dotted rgba(226,232,240,.72) !important;\n  transform:translateX(-50%) !important;\n  z-index:2 !important;\n}\n\n#entrega .entregaStep::after{\n  top:65px !important;\n  z-index:4 !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:0%"]::before{\n  left:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:100%"]::before{\n  left:auto !important;\n  right:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep:not(.hasDate)::before{\n  content:none !important;\n  display:none !important;\n}\n';
...
/* ===== v2.0.185 - Entregas: avance por registros + bandera Tierra del Fuego =====
...
/* ===== v2.0.185 - Entregas: timeline por registros reales corregido =====
   Solo afecta la vista Entregas. No modifica diseño ni otros módulos. */
(function(){
  const CSS = `
/* ===== v2.0.185 - Entregas: extremos y registros reales =====
...
/* ===== v2.0.185 - Entregas: hitos desde Aduanas + camión por último registro ===== */
(function(){
const CSS=`
/* v2.0.185 - Entregas: aduanas y avance real */
...
/* ===== v2.0.185 - Entregas: abreviatura visual de hitos =====
...
/* ===== v2.0.185 - Entregas: hitos desde colección aduana por campo destino =====
...
/* ===== v2.0.185 - Entregas: botón Actualizar refresca timeline =====
...
/* ===== v2.0.185 - Entregas: Actualizar reconstruye la línea como al reingresar =====
   Solo afecta el botón Actualizar de Entregas. No modifica estética ni otros módulos. */
(function(){
...
/* ===== v2.0.185 - Entregas: Actualizar sin parpadeo =====
...
/* ===== v2.0.185 - Entregas: Actualizar in-place sin reconstruir tarjeta =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v2.0.185 - Entregas: Actualizar aislado, sin render viejo =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v2.0.185 - Version final + Entregas boton aislado dominante ===== */
(function(){
  const VERSION_FINAL_173 = '2.0.185';
...
/* ===== v2.0.185 - Reporte PDF: hitos desde colección aduana =====
...
/* ===== v2.0.185 - Forzado final de versión visible y PDF ===== */
(function(){
  const VERSION_FINAL_177 = '2.0.185';
...
/* ===== v2.0.185 - Alertas: sin KM heredado, sin observers =====
   Base v2.0.185. Solo afecta Alertas. No toca Tránsitos, Entregas, PDF ni estética. */
(function(){
  const VERSION_ALERTAS_183='2.0.185';
...
/* ===== v2.0.185 - Alertas: columnas alineadas sin KM =====
   Solo ajusta la tabla de detalle de Alertas. No toca otros modulos. */
(function(){
  const VERSION_ALERTAS_185='2.0.185';
