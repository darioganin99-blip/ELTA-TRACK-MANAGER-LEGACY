...
/* ===== V2.0.69 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.69";
...
/* ===== V2.0.69 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.69 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.69 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.69 ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.69";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.69 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.69 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.69 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.69';
...
/* ===== V2.0.69 - Normalizacion definitiva SOLO menu lateral ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Fix definitivo menú lateral, hamburguesa y campana sin contador ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.69 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.69';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.143';});
})();


/* ===== V2.0.69 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.69";
...
/* ===== V2.0.69 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.69";
...
/* ===== V2.0.69 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.69 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.69 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.69';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.143 - SOLO agregado menu Entregas + linea de tiempo (sin tocar Embarques) ===== */
(function(){
  const VERSION='2.0.143';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function getArr(n){
    try{ if(Array.isArray(window[n])) return window[n]; }catch(e){}
    try{ if(n==='trs' && typeof trs!=='undefined' && Array.isArray(trs)) return trs; }catch(e){}
    try{ if(n==='users' && typeof users!=='undefined' && Array.isArray(users)) return users; }catch(e){}
    try{ if(n==='clientes' && typeof clientes!=='undefined' && Array.isArray(clientes)) return clientes; }catch(e){}
    try{ if(n==='origenes' && typeof origenes!=='undefined' && Array.isArray(origenes)) return origenes; }catch(e){}
    try{ if(n==='destinos' && typeof destinos!=='undefined' && Array.isArray(destinos)) return destinos; }catch(e){}
    try{ if(n==='embarques' && typeof embarques!=='undefined' && Array.isArray(embarques)) return embarques; }catch(e){}
    try{ if(n==='aduana' && typeof aduana!=='undefined' && Array.isArray(aduana)) return aduana; }catch(e){}
    return [];
  }
  function field(o,keys){ for(const k of keys){ const v=o?.[k]; if(v!==undefined && v!==null && S(v)!=='') return v; } return ''; }
  function idOf(o){ return S(o?._docId||o?.id||o?.numero||o?.embarque||''); }
  function fmt(v){ try{ if(!v) return '-'; if(v?.toDate) v=v.toDate(); const d=new Date(v); if(isNaN(d)) return S(v)||'-'; return d.toLocaleString('es-AR',{day:'2-digit',month:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit'}); }catch(e){ return S(v)||'-'; } }
  function shortFmt(v){ try{ if(!v) return '-'; if(v?.toDate) v=v.toDate(); const d=new Date(v); if(isNaN(d)) return S(v)||'-'; return d.toLocaleString('es-AR',{day:'2-digit',month:'2-digit',hour:'2-digit',minute:'2-digit'}); }catch(e){ return S(v)||'-'; } }
  function setVersion(){
  ...
  function countryOf(v){
    const s=L(v);
    if(/\b(brasil|brazil|sao paulo|curitiba|porto alegre|br)\b/.test(s)) return 'brasil';
    if(/\b(chile|stli|santiago|pudahuel|los andes|libertadores|cristo redentor|cl)\b/.test(s)) return 'chile';
    ...
    if(/\b(argentina|arg|ar|zarate|cordoba|fca|planta fca|centro logistico|clz|clc|tz)\b/.test(s)) return 'argentina';
    return '';
  }
  ...
  function ensureMenu(){
    ...
    const entregaButtons=buttons.filter(b=>(b.dataset.menuId==='entrega') || ((b.getAttribute('onclick')||'').includes("tab('entrega')")) || L(b.textContent).includes('entregas'));
    let btn=entregaButtons[0];
    ...
    if(emb && emb.nextSibling!==btn) emb.parentNode.insertBefore(btn, emb.nextSibling);
  ...
  function ensurePanel(){
    ...
    if(!sec){
      ...
      (emb&&emb.parentNode?emb.parentNode:document.querySelector('.dashboardShell')||document.body).insertBefore(sec, emb?emb.nextSibling:null);
    }
  }
  function embMap(){ const m=new Map(); getArr('embarques').forEach(e=>{ const n=embNo(e); if(n)m.set(String(n),e); }); return m; }
  function buildRows(){
    const em=embMap(), groups=new Map();
    getArr('trs').forEach(t=>{ const fl=trFleet(t); if(!fl)return; const n=trEmb(t), e=em.get(String(n))||{}, rt=route(t)||{}; if(!groups.has(fl))groups.set(fl,{flota:fl,items:[]}); groups.get(fl).items.push({t,e,rt,n}); });
    getArr('embarques').forEach(e=>{ const fl=S(field(e,['flota','flotas'])); if(!fl)return; fl.split(',').map(x=>x.trim()).filter(Boolean).forEach(f=>{ if(!groups.has(f))groups.set(f,{flota:f,items:[]}); if(!groups.get(f).items.length)groups.get(f).items.push({t:{},e,rt:{},n:embNo(e)}); }); });
  ...
  function stages(row){ let mid=aduanaFor(row); if(!mid.length){ const d=countryOf(row.destino); if(d==='chile')mid=['Uspallata','Los Andes']; else if(d==='paraguay')mid=['Clorinda','Puerto José Falcón','Depósito Fiscal Paraguay']; else if(d==='uruguay')mid=['Gualeguaychú','Fray Bentos']; else if(d==='brasil')mid=['Paso fronterizo','Destino Brasil']; } return [S(row.origen)||'Origen',...mid,S(row.destino)||'Lugar de entrega'].filter(Boolean).slice(0,8); }
  ...
  const oldTab=window.tab;
  if(typeof oldTab==='function' && !oldTab.__entrega143){
    const wrapped=function(id){ boot(); const r=oldTab.apply(this,arguments); if(id==='entrega') setTimeout(()=>window.renderEntrega(false),30); return r; };
    wrapped.__entrega143=true; window.tab=wrapped;
  }
