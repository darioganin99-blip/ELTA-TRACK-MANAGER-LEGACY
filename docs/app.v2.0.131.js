...
const ELTA_APP_VERSION = "2.0.124";
...
/* ===== V2.0.124 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.124";
...
/* ===== V2.0.124 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.124 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.124 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.124 ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.124";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.124 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.124 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.124 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.124';
...
/* ===== V2.0.124 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.124 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.124 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.124';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.124';});
})();


/* ===== V2.0.124 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.124";
...
/* ===== V2.0.124 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.124";
...
/* ===== V2.0.124 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.124 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.124';
...
/* ===== V2.0.124 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.124';
...
/* ===== V2.0.124 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.124';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.124 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.124';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.124 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.124 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Entrega por flota, compacta y con aduanas por pais destino ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - Entrega: flota, banderas por pais, aduanas por destino, compacto ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - ajuste final SOLO Entregas: menú estable, timeline sin superposición ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
  function setV(){
...
/* ===== V2.0.124 - FIX FINAL VERSION Y MENU ESTABLE ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - SOLO ENTREGAS: icono único y tarjeta según boceto ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - SOLO ENTREGAS: tarjeta compacta, camion reducido, banderas icono ===== */
(function(){
  const VERSION='2.0.124';
  function applyVersion(){
    window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO ENTREGAS: tarjeta igual al boceto, hitos sobre linea, camion chico, banderas reales ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - SOLO ENTREGAS: tarjeta reconstruida igual boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.124';
  function setVer(){
...
/* ===== V2.0.124 - CORRECCION FINAL SOLO ENTREGAS: tarjeta igual al boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO Entregas: tarjeta compacta final y 2 banderas reales ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO Entregas: contenedor compacto, hitos sobre linea, sin checks, 2 banderas ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - SOLO Entregas: correccion real tarjeta compacta, banderas y timeline ===== */
(function(){
  const VERSION='2.0.124';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.124 - FIX FINAL SOLO ENTREGAS: banderas reales + iconos cabecera, sin tocar menu ni Embarques ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - FIX FINAL SOLO ENTREGAS: version unica + banderas reales visibles ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - FIX DEFINITIVO SOLO ENTREGAS: banderas reales dinamicas + version estable ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - SOLO ENTREGAS: banderas reales y contenedores alternados ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - FIX FINAL SOLO ENTREGAS: banderas visibles, version estable, contenedor alternado ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.124 - FIX REAL SOLO ENTREGAS: banderas origen/destino + segundo contenedor mas claro ===== */
(function(){
  const VERSION='2.0.124';
...
/* ===== V2.0.131 - SOLO ENTREGAS: filtros compactos y eventos estables ===== */
(function(){
  const VERSION='2.0.131';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
  ...
  function ensureFilterCss(){
    if(document.getElementById('entregas-filtros-final-20131')) return;
    const st=document.createElement('style');
    st.id='entregas-filtros-final-20131';
    st.textContent=`
      #entrega .entregaToolbar{
        display:grid!important;
        grid-template-columns:1.15fr 1.15fr 1.35fr .9fr!important;
        gap:12px!important;
      ...
      #entrega .entregaToolbar label.entregaFilterHidden{display:none!important;}
        ...
        border-color:rgba(157,255,126,.62)!important;
        box-shadow:0 0 0 2px rgba(82,255,96,.10)!important;
      }
      #entrega .entregaToolbar label[for],
      #entrega .entregaToolbar .filterLabel{display:none!important;}
      @media(max-width:1100px){
        #entrega .entregaToolbar{grid-template-columns:1fr 1fr!important;}
      }
    `;
    document.head.appendChild(st);
  }
  ...
  function clearLabelText(label){
    Array.from(label.childNodes).forEach(n=>{ if(n.nodeType===3) n.textContent=''; });
  }

  function setFirstOption(sel, text){
    if(!sel) return;
    let first=sel.querySelector('option[value=""]') || sel.options[0];
    if(first) first.textContent=text;
  }

  function bindFilter(sel){
    if(!sel || sel.__entregaFilterFinalBound) return;
    sel.__entregaFilterFinalBound=true;
  ...
  function normalizeEntregaFilters(){
    ensureFilterCss();
    setVersion();
    const tb=document.querySelector('#entrega .entregaToolbar');
    if(!tb) return;
    ...
    const order=[emb,flo,cli,est];

    // Mantener los mismos controles e IDs para no romper la lógica existente.
    order.forEach((sel,idx)=>{
      if(!sel) return;
      const label=sel.closest('label') || sel.parentElement;
      if(label){
        clearLabelText(label);
        label.classList.remove('entregaFilterHidden');
        label.style.order=String(idx+1);
      }
      bindFilter(sel);
    });
    if(des){
      bindFilter(des);
      const label=des.closest('label') || des.parentElement;
      if(label) label.classList.add('entregaFilterHidden');
    }

    setFirstOption(emb,'Embarque');
    setFirstOption(flo,'Todas las flotas');
    setFirstOption(cli,'Todos los clientes');
    setFirstOption(est,'Todos');
  }

  function installRenderHook(){
    if(typeof window.renderEntrega==='function' && !window.renderEntrega.__filtersFinal20131){
      const old=window.renderEntrega;
      const wrapped=async function(){
        const r=await old.apply(this,arguments);
        normalizeEntregaFilters();
        setTimeout(normalizeEntregaFilters,40);
        return r;
      };
      wrapped.__filtersFinal20131=true;
  ...
  const oldTab=window.tab;
  if(typeof oldTab==='function' && !oldTab.__filtersFinal20131){
    const wrapped=function(id){
      const r=oldTab.apply(this,arguments);
      if(id==='entrega'){
        setTimeout(boot,0);
        setTimeout(()=>{ if(typeof window.renderEntrega==='function') window.renderEntrega(false); },30);
        setTimeout(boot,120);
      }
      return r;
    };
  ...
  document.addEventListener('DOMContentLoaded',()=>{boot(); setTimeout(boot,250); setTimeout(boot,900);});
  window.addEventListener('load',()=>{boot(); setTimeout(boot,250); setTimeout(boot,900);});
  setTimeout(boot,100);
