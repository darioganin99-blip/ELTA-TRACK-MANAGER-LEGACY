...
/* ===== V2.0.9 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.9";
...
/* ===== V2.0.9 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='2.0.9';
...
/* ===== V2.0.9 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.9';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.9 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
