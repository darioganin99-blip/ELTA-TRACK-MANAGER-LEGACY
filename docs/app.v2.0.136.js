...
const ELTA_APP_VERSION = "2.0.136";
...
/* ===== V2.0.136 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.136";
...
/* ===== V2.0.136 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.136 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.136 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.136 ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.136";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.136 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.136 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.136 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.136';
...
/* ===== V2.0.136 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.136 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.136 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.136';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.136';});
})();


/* ===== V2.0.136 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.136";
...
/* ===== V2.0.136 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.136";
...
/* ===== V2.0.136 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.136 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.136';
...
/* ===== V2.0.136 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.136';
...
/* ===== V2.0.136 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.136';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.136 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.136';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.136 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.136 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Entrega por flota, compacta y con aduanas por pais destino ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - Entrega: flota, banderas por pais, aduanas por destino, compacto ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - ajuste final SOLO Entregas: menú estable, timeline sin superposición ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
  function setV(){
...
/* ===== V2.0.136 - FIX FINAL VERSION Y MENU ESTABLE ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - SOLO ENTREGAS: icono único y tarjeta según boceto ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - SOLO ENTREGAS: tarjeta compacta, camion reducido, banderas icono ===== */
(function(){
  const VERSION='2.0.136';
  function applyVersion(){
    window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO ENTREGAS: tarjeta igual al boceto, hitos sobre linea, camion chico, banderas reales ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - SOLO ENTREGAS: tarjeta reconstruida igual boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.136';
  function setVer(){
...
/* ===== V2.0.136 - CORRECCION FINAL SOLO ENTREGAS: tarjeta igual al boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO Entregas: tarjeta compacta final y 2 banderas reales ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO Entregas: contenedor compacto, hitos sobre linea, sin checks, 2 banderas ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - SOLO Entregas: correccion real tarjeta compacta, banderas y timeline ===== */
(function(){
  const VERSION='2.0.136';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.136 - FIX FINAL SOLO ENTREGAS: banderas reales + iconos cabecera, sin tocar menu ni Embarques ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - FIX FINAL SOLO ENTREGAS: version unica + banderas reales visibles ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - FIX DEFINITIVO SOLO ENTREGAS: banderas reales dinamicas + version estable ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - SOLO ENTREGAS: banderas reales y contenedores alternados ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - FIX FINAL SOLO ENTREGAS: banderas visibles, version estable, contenedor alternado ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - FIX REAL SOLO ENTREGAS: banderas origen/destino + segundo contenedor mas claro ===== */
(function(){
  const VERSION='2.0.136';
...
/* ===== V2.0.136 - SOLO ENTREGAS: filtros compactos y estables ===== */
(function(){
  const VERSION='2.0.136';
  function setVersion(){
...
/* ===== V2.0.136 - FIX SEGURO MENU ENTREGAS: sin wrappers, sin refresh, sin romper inicio ===== */
(function(){
  const VERSION='2.0.136';
  const ENTREGA_ICON='🚛';
  function el(id){return document.getElementById(id)}
  function setVersion136(){
    try{
      window.ELTA_APP_VERSION=VERSION;
      window.APP_VERSION_V2=VERSION;
      document.title='ELTA ITS - Versión '+VERSION;
      document.querySelectorAll('span,small,p,div,footer').forEach(x=>{
        if(x.childElementCount===0 && /Versi[oó]n\s+\d+\.\d+\.\d+/i.test(x.textContent||'')){
          x.textContent=(x.textContent||'').replace(/Versi[oó]n\s+\d+\.\d+\.\d+/gi,'Versión '+VERSION);
        }
      });
    }catch(e){}
  }
  function normalizeEntregaMenu136(){
    const nav=document.querySelector('.sideNav');
    if(!nav) return;
    const isEntrega=b=>((b.dataset&&b.dataset.menuId==='entrega')||String(b.getAttribute('onclick')||'').includes('entrega')||String(b.textContent||'').trim().toLowerCase()==='entregas');
    let list=[...nav.querySelectorAll('button')].filter(isEntrega);
    let btn=list[0];
    if(!btn){
      btn=document.createElement('button');
      const emb=[...nav.querySelectorAll('button')].find(b=>String(b.getAttribute('onclick')||'').includes('embarques'));
      if(emb) emb.insertAdjacentElement('afterend',btn); else nav.appendChild(btn);
    }
    list.slice(1).forEach(b=>b.remove());
    btn.type='button';
    btn.dataset.menuId='entrega';
    btn.setAttribute('onclick',"tab('entrega')");
    btn.title='Entregas';
    btn.innerHTML='<span class="menuIcon" aria-hidden="true">'+ENTREGA_ICON+'</span><span class="menuText">Entregas</span>';
    const emb=[...nav.querySelectorAll('button')].find(b=>String(b.getAttribute('onclick')||'').includes('embarques'));
    if(emb && emb.nextElementSibling!==btn) emb.insertAdjacentElement('afterend',btn);
  }
  function ensureEntregaExists136(){
    try{
      if(!el('entrega') && typeof window.renderEntrega==='function') window.renderEntrega(false);
    }catch(e){}
  }
  function activatePanel136(id){
    document.querySelectorAll('.sideNav button').forEach(b=>b.classList.remove('active'));
    document.querySelectorAll('.panel').forEach(p=>p.classList.remove('active'));
    const btn=[...document.querySelectorAll('.sideNav button')].find(b=>String(b.getAttribute('onclick')||'').includes("'"+id+"'")||String(b.getAttribute('onclick')||'').includes('"'+id+'"')||(id==='entrega'&&b.dataset.menuId==='entrega'));
    if(btn) btn.classList.add('active');
    const panel=el(id); if(panel) panel.classList.add('active');
  }
  window.tab=function(id){
    id=String(id||'');
    setVersion136();
    normalizeEntregaMenu136();
    const active=document.querySelector('.panel.active')?.id;
    if(id==='entrega'){
      if(active==='entrega') return false;
      ensureEntregaExists136();
      activatePanel136('entrega');
      try{ if(typeof window.renderEntrega==='function') setTimeout(()=>window.renderEntrega(false),0); }catch(e){}
      setTimeout(()=>{normalizeEntregaMenu136();setVersion136();},40);
      return false;
    }
    activatePanel136(id);
    try{
      ...
      if(id==='clima'&&typeof window.ensureClimaDataAndRender==='function') setTimeout(()=>window.ensureClimaDataAndRender(false),0);
    }catch(e){console.warn('tab v2.0.136',e);}
    setTimeout(()=>{normalizeEntregaMenu136();setVersion136();},40);
    return false;
  };
  function injectStableIconCss136(){
    if(document.getElementById('entrega-menu-v20136-css')) return;
    const s=document.createElement('style');
    s.id='entrega-menu-v20136-css';
    s.textContent=`.sideNav button[data-menu-id="entrega"] .menuIcon,.sideNav button[onclick*="entrega"] .menuIcon{font-size:0!important;line-height:1!important}.sideNav button[data-menu-id="entrega"] .menuIcon:before,.sideNav button[onclick*="entrega"] .menuIcon:before{content:'${ENTREGA_ICON}';font-size:22px!important;line-height:1!important}`;
    document.head.appendChild(s);
  }
  function boot136(){injectStableIconCss136();normalizeEntregaMenu136();setVersion136();}
  if(document.readyState==='loading') document.addEventListener('DOMContentLoaded',boot136); else boot136();
  window.addEventListener('load',()=>{boot136();setTimeout(boot136,250);});
  window.normalizeEntregaMenu136=normalizeEntregaMenu136;
})();
