...
/* ===== V2.0.58 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.58";
...
/* ===== V2.0.58 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.58 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.58 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.58 ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.58";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.58 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.58 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.58 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.58';
...
/* ===== V2.0.58 - Normalizacion definitiva SOLO menu lateral ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Fix definitivo menú lateral, hamburguesa y campana sin contador ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.58 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.58';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.58';});
})();


/* ===== V2.0.58 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.58 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.58";
...
/* ===== V2.0.58 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.58';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function embDocValue(e){return String(e?.id??e?.embarque??e?.numero??e?.nro??e?.codigo??'').trim();}
  ...
  function destinationsForClimaV257(list){
    ...
    if(embDest){
      ...
      if(!matches.length){
        matches=[{id:embDest,nombre:embDest,destino:embDest,localidad:embDest,pais:/chile|stli|santiago|pudahuel/i.test(embDest)?'Chile':'-',_pseudo:true}];
      }
    }else{
      list.forEach(t=>{
        const r=route(t);
    ...
    const seen=new Set();
    return matches.filter(d=>{const k=norm((d?.id||'')+'|'+destName(d)+'|'+destPais(d)); if(seen.has(k))return false; seen.add(k); return true;});
  }
  ...
  window.ensureClimaDataAndRender=async function(){
    try{
      if(!Array.isArray(trs)||!Array.isArray(destinos)||!Array.isArray(embarques)){
        [trs,users,clientes,origenes,destinos,embarques]=await Promise.all([read('transitos'),read('usuarios'),read('clientes'),read('origenes'),read('destinos'),read('embarque')]);
      }
    }catch(e){console.warn('No se pudieron cargar datos clima',e);}
    await window.renderClima();
