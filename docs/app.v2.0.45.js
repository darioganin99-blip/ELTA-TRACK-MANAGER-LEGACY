...
/* ===== V2.0.45 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.45";
...
/* ===== V2.0.45 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.45 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.45 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.45 ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.45";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.45 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.45 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.45 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.45';
...
/* ===== V2.0.45 - Normalizacion definitiva SOLO menu lateral ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Fix definitivo menú lateral, hamburguesa y campana sin contador ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.45 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  window.resetEmbarqueFiltersV244=function(){['embFilterCliente','embFilterOrigen','embFilterDestino'].forEach(id=>{const e=$id(id); if(e)e.value='';}); window.renderEmbarquesV244();};
...
/* ===== V2.0.45 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.45';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  const nameFromDoc=(x,kind)=>{
    ...
    if(kind==='cliente') return x.nombre||x.name||x.cliente||x.razonSocial||x.razon_social||x.descripcion||x.id||'';
    if(kind==='origen') return x.nombre||x.name||x.origen||x.ubicacion||x.localidad||x.descripcion||x.id||'';
    if(kind==='destino') return x.nombre||x.name||x.destino||x.ubicacion||x.localidad||x.descripcion||x.id||'';
  ...
  function lists(){
    const cli=U([...data('clientes').map(x=>nameFromDoc(x,'cliente')), ...data('trs').map(t=>route(t).cliente)]);
    const ori=U([...data('origenes').map(x=>nameFromDoc(x,'origen')), ...data('trs').map(t=>route(t).origen)]);
    const des=U([...data('destinos').map(x=>nameFromDoc(x,'destino')), ...data('trs').map(t=>route(t).destino)]);
    return {cli,ori,des};
  }
  ...
  window.renderEmbarquesV244=async function(){
    ...
    const rows=build().filter(e=>(!fc||L(e.cliente)===fc)&&(!fo||L(e.origen)===fo)&&(!fdest||L(e.destino)===fdest));
    const cgs=cargas();
    const tbody=$id('embarquesTbody');
    if(tbody){
      tbody.innerHTML=rows.map(e=>{
