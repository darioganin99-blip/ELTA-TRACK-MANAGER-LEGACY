...
const ELTA_APP_VERSION='2.0.178';
...
/* ===== V2.0.178 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2='2.0.178';
...
/* ===== V2.0.178 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='2.0.178';
...
/* ===== V2.0.178 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.178 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.178 ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.178";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.178 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.178 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.178 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2173 = '2.0.178';
...
/* ===== V2.0.178 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.178 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.178 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.178';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.178';});
})();


/* ===== V2.0.178 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.178";
...
/* ===== V2.0.178 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.178";
...
/* ===== V2.0.178 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.178 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.178';
...
/* ===== V2.0.178 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.178';
...
/* ===== V2.0.178 - Version lock definitivo ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.178 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.178';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.178 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.178 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.178 - ENTREGAS: ROUTING UNICO SIN REFRESH ===== */
(function(){
  'use strict';
  const VERSION='2.0.178';
  window.ELTA_APP_VERSION=VERSION;
...
/* ===== v2.0.178 - CSS final linea desde circulo Entregas ===== */
(function(){
  const CSS = '\n/* ===== v2.0.178 - Entregas: linea vertical nace desde el circulo =====\n   SOLO afecta la vista #entrega. No modifica icono de camion ni otros modulos. */\n\n#entrega .entregaStep.hasDate::before{\n  content:"" !important;\n  position:absolute !important;\n  left:50% !important;\n  top:32px !important;\n  height:33px !important;\n  border-left:2px dotted rgba(226,232,240,.72) !important;\n  transform:translateX(-50%) !important;\n  z-index:2 !important;\n}\n\n#entrega .entregaStep::after{\n  top:65px !important;\n  z-index:4 !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:0%"]::before{\n  left:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:100%"]::before{\n  left:auto !important;\n  right:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep:not(.hasDate)::before{\n  content:none !important;\n  display:none !important;\n}\n';
...
/* ===== v2.0.178 - Entregas: avance por registros + bandera Tierra del Fuego =====
...
/* ===== v2.0.178 - Entregas: timeline por registros reales corregido =====
   Solo afecta la vista Entregas. No modifica diseño ni otros módulos. */
(function(){
  const CSS = `
/* ===== v2.0.178 - Entregas: extremos y registros reales =====
...
/* ===== v2.0.178 - Entregas: hitos desde Aduanas + camión por último registro ===== */
(function(){
const CSS=`
/* v2.0.178 - Entregas: aduanas y avance real */
...
/* ===== v2.0.178 - Entregas: abreviatura visual de hitos =====
...
/* ===== v2.0.178 - Entregas: hitos desde colección aduana por campo destino =====
...
/* ===== v2.0.178 - Entregas: botón Actualizar refresca timeline =====
...
/* ===== v2.0.178 - Entregas: Actualizar reconstruye la línea como al reingresar =====
   Solo afecta el botón Actualizar de Entregas. No modifica estética ni otros módulos. */
(function(){
...
/* ===== v2.0.178 - Entregas: Actualizar sin parpadeo =====
...
/* ===== v2.0.178 - Entregas: Actualizar in-place sin reconstruir tarjeta =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v2.0.178 - Entregas: Actualizar aislado, sin render viejo =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v2.0.178 - Version final + Entregas boton aislado dominante ===== */
(function(){
  const VERSION_FINAL_173 = '2.0.178';
...
/* ===== v2.0.178 - Reporte PDF: hitos desde colección aduana =====
...
/* ===== v2.0.178 - Forzado final de versión visible y PDF ===== */
(function(){
  const VERSION_FINAL_177 = '2.0.178';
...
/* ===== v2.0.178 - Alertas/Tránsitos: bloqueo de render viejo intermedio =====
   No cambia estética ni lógica. Evita que se vea el render heredado durante el refresh de pantalla. */
(function(){
  const VERSION_178 = '2.0.178';
  window.ELTA_APP_VERSION = VERSION_178;
  window.APP_VERSION_V2 = VERSION_178;

  let timers178 = {};

  function setVersion178(){
    document.title = 'ELTA ITS - Versión ' + VERSION_178;
    document.querySelectorAll('span,small,p,div').forEach(el=>{
      if(el.childElementCount===0 && /Versi[oó]n\s+\d+\.\d+\.\d+/.test(el.textContent||'')){
        el.textContent = (el.textContent||'').replace(/Versi[oó]n\s+\d+\.\d+\.\d+/g,'Versión '+VERSION_178);
      }
    });
  }

  function panel178(id){
  ...
  function hold178(id){
    const p = panel178(id);
    if(!p) return;
    p.classList.add('renderHold178');
    if(timers178[id]) clearTimeout(timers178[id]);
  }

  function release178(id){
    const p = panel178(id);
    if(!p) return;
    p.classList.remove('renderHold178');
  }

  function stableRender178(id){
    try{
      if(id === 'alertas' && typeof window.renderAlerts === 'function'){
        window.renderAlerts();
        sanitizeAlertas178();
      }
      if(id === 'transitos'){
        if(typeof window.renderTransitos === 'function') window.renderTransitos();
        else if(typeof renderTransitos === 'function') renderTransitos();
      }
    }catch(e){
      console.warn('stableRender178', id, e);
    }
    setVersion178();
  }

  function stabilize178(id){
    if(id !== 'alertas' && id !== 'transitos') return;
    hold178(id);

    // Deja pasar los setTimeout/render heredados y muestra únicamente el resultado estable.
    [80, 180, 320].forEach(ms=>{
      setTimeout(()=>stableRender178(id), ms);
    });

    timers178[id] = setTimeout(()=>{
      stableRender178(id);
      release178(id);
    }, 420);
  }

  function sanitizeAlertas178(){
    // Defensa puntual: si un render viejo agrega columna KM, se elimina del DOM antes de mostrar.
    const root = panel178('alertas');
    if(!root) return;
  ...
  const oldTab178 = window.tab;
  if(typeof oldTab178 === 'function' && !oldTab178.__renderGuard178){
    window.tab = function(id){
      if(id === 'alertas' || id === 'transitos') hold178(id);
      const r = oldTab178.apply(this, arguments);
      if(id === 'alertas' || id === 'transitos') stabilize178(id);
      return r;
    };
    window.tab.__renderGuard178 = true;
  }

  // También cubre botones/filtros internos que disparen refresh estando dentro de esas vistas.
  const oldRefresh178 = window.refresh;
  if(typeof oldRefresh178 === 'function' && !oldRefresh178.__renderGuard178){
    window.refresh = async function(){
      const active = document.querySelector('.panel.active')?.id || '';
      if(active === 'alertas' || active === 'transitos') hold178(active);
      const r = await oldRefresh178.apply(this, arguments);
      if(active === 'alertas' || active === 'transitos') stabilize178(active);
      return r;
    };
    window.refresh.__renderGuard178 = true;
  }

  const oldRenderAlerts178 = window.renderAlerts;
  if(typeof oldRenderAlerts178 === 'function' && !oldRenderAlerts178.__sanitize178){
    window.renderAlerts = function(){
      const r = oldRenderAlerts178.apply(this, arguments);
      sanitizeAlertas178();
      return r;
    };
    window.renderAlerts.__sanitize178 = true;
  }

  document.addEventListener('DOMContentLoaded',()=>{ setVersion178(); sanitizeAlertas178(); });
  window.addEventListener('load',()=>{ setVersion178(); sanitizeAlertas178(); });
  setTimeout(()=>{ setVersion178(); sanitizeAlertas178(); }, 600);
})();
