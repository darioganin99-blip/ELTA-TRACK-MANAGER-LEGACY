...
/* ===== V2.0.96 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.96";
...
/* ===== V2.0.96 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.96 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.96 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.96 ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.96";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.96 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.96 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.96 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.96';
...
/* ===== V2.0.96 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.96 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.96 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.96';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.96';});
})();


/* ===== V2.0.96 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.96";
...
/* ===== V2.0.96 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.96";
...
/* ===== V2.0.96 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.96 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.96';
...
/* ===== V2.0.96 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.96';
...
/* ===== V2.0.96 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.96';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.96 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.96';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.96 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.96 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.96 - Nuevo menu Entrega: vista de avance de embarques ===== */
(function(){
  const VERSION='2.0.96';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function flagFor(v){
    const s=low(v);
    if(s.includes('arg')||s.includes('zarate')||s.includes('zárate')||s.includes('fca')||s.includes('cordoba')||s.includes('córdoba'))return '🇦🇷';
    if(s.includes('paraguay')||s.includes('falcon')||s.includes('falcón')||s.includes('asuncion')||s.includes('asunción'))return '🇵🇾';
    if(s.includes('uruguay')||s.includes('montevideo')||s.includes('sevel'))return '🇺🇾';
    if(s.includes('chile')||s.includes('stli')||s.includes('los andes'))return '🇨🇱';
    return '🌐';
  }
  function statusFor(t,e){
    const s=low(t?.estado||t?.status||e?.estado||e?.status||'');
    if(s.includes('final')||t?.closed||t?.cierre)return {txt:'ENTREGADO',cls:'done'};
  ...
  function route(t){
    if(typeof ruta==='function'){try{return ruta(t)||{};}catch(e){}}
    return t?.ruta||t?.route||{};
  }
  function locName(t){
    if(typeof locFull==='function'){try{return locFull(t)||'';}catch(e){}}
    if(typeof loc==='function'){try{return loc(t)||'';}catch(e){}}
    return txt(t?.localidad||t?.ubicacion||t?.location,'');
  }
  function lastTime(t){return t?.updatedAt||t?.lastUpdate||t?.lastReport||t?.ultimoReporte||t?.start?.time||t?.start||'';}
  ...
  function ensureMenu(){
    ...
    if(!btn){
      ...
      btn.innerHTML='<span class="menuIcon">🚚</span><span class="menuText">Entrega</span>';
      const emb=[...nav.querySelectorAll('button')].find(b=>(b.getAttribute('onclick')||'').includes('embarques'));
      if(emb&&emb.nextSibling)nav.insertBefore(btn,emb.nextSibling); else if(emb)nav.insertBefore(btn,emb.nextSibling); else nav.appendChild(btn);
    }else{
      ...
      const mt=btn.querySelector('.menuText')||document.createElement('span'); mt.className='menuText'; mt.textContent='Entrega';
  ...
  function ensurePanel(){
    ...
    sec.id='entrega'; sec.className='panel entregaPanel';
    sec.innerHTML=`
      <div class="sectionTitle"><h2>Entrega</h2><p>Seguimiento de avance por embarque</p></div>
      <div class="entregaToolbar glassPanel">
        <label>Cliente<select id="entregaFiltroCliente"><option value="">Todos los clientes</option></select></label>
        <label>Embarque<select id="entregaFiltroEmbarque"><option value="">Todos los embarques</option></select></label>
        <label>Destino<select id="entregaFiltroDestino"><option value="">Todos los destinos</option></select></label>
        <button type="button" class="entregaRefreshBtn" onclick="window.renderEntrega && window.renderEntrega(true)">Actualizar</button>
      </div>
  ...
  function buildRows(){
    ...
    const map=new Map();
    embs.forEach(e=>{const n=embValue(e); if(n)map.set(String(n),{numero:String(n),embarque:e,transitos:[]});});
    trs.forEach(t=>{const n=trEmb(t); if(!n)return; if(!map.has(String(n)))map.set(String(n),{numero:String(n),embarque:null,transitos:[]}); map.get(String(n)).transitos.push(t);});
    return [...map.values()].map(r=>{
      const t=r.transitos[0]||{}; const rt=route(t)||{}; const e=r.embarque||{};
      return {
        numero:r.numero,
        cliente:txt(embCliente(e)||rt.cliente||t.cliente,''),
        origen:txt(embOrigen(e)||rt.origen||t.origen,''),
        destino:txt(embDestino(e)||rt.destino||t.destino,''),
        fecha:embFecha(e)||t.fecha||t.start?.time||t.start||'',
        factura:txt(e.factura||e.facturaN||t.factura||t.facturaN||'-'),
        mic:txt(e.mic||t.mic||t.nroMic||'-'),
        crt:txt(e.crt||t.crt||t.nroCrt||'-'),
        flota:txt((r.transitos.map(trFleet).filter(Boolean).join(', '))||e.flota||e.flotas||t.flota||'-'),
        transit:t, emb:e
      };
    }).sort((a,b)=>String(b.fecha||b.numero).localeCompare(String(a.fecha||a.numero),'es',{numeric:true}));
  }
  function stageList(row){
    const ads=(window.aduana||[]).filter(a=>a&&a.activo!==false).sort((a,b)=>(Number(a.orden)||99)-(Number(b.orden)||99));
    let middle=ads.slice(0,2).map(a=>txt(a.destino||a.nombre||a.id||a._docId,''));
    if(!middle.length){
      const d=low(row.destino);
      if(d.includes('paraguay'))middle=['Clorinda','Puerto José Falcón'];
      else if(d.includes('chile'))middle=['Uspallata','Los Andes'];
      else if(d.includes('uruguay'))middle=['Fray Bentos','Depósito Fiscal'];
      else middle=['Control operativo','Ruta'];
    }
    return [txt(row.origen||'Origen'),...middle,txt(row.destino||'Lugar de entrega')].slice(0,4);
  }
  function progressIndex(row){
    const s=low(row.transit?.estado||row.emb?.estado||'');
    if(s.includes('final'))return 3;
    if(s.includes('aduana'))return 1;
    if(row.transit&&Object.keys(row.transit).length)return 1;
    return 0;
  }
  function card(row){
    const stages=stageList(row), pi=progressIndex(row), st=statusFor(row.transit,row.emb);
    const fromFlag=flagFor(row.origen), toFlag=flagFor(row.destino);
    const nowLabel=fmt(lastTime(row.transit));
    const pct=Math.max(0,Math.min(100,(pi/(Math.max(1,stages.length-1)))*100));
    return `<article class="entregaCard">
      <div class="entregaTop">
        <div class="entregaEmb"><span class="entregaBoxIcon">📦</span><div><h3>Emb. ${esc(row.numero)}</h3><span class="entregaStatus ${st.cls}">${esc(st.txt)}</span></div></div>
        <div class="entregaMeta"><b>Fecha prog.</b><span>${esc(fmt(row.fecha))}</span></div>
        <div class="entregaMeta"><b>Factura</b><span>${esc(row.factura)}</span></div>
        <div class="entregaMeta"><b>Flota</b><span>${esc(row.flota)}</span></div>
        <div class="entregaMeta"><b>MIC</b><span>${esc(row.mic)}</span></div>
        <div class="entregaMeta"><b>CRT</b><span>${esc(row.crt)}</span></div>
        <div class="entregaFlags"><span>${fromFlag}</span><span>${toFlag}</span></div>
      </div>
      <div class="entregaTimeline">
        <div class="entregaLine"><i style="width:${pct}%"></i></div>
        ${stages.map((s,i)=>`<div class="entregaStep ${i<=pi?'done':''} ${i===pi?'current':''}" style="left:${(i/(stages.length-1))*100}%"><span class="pin">📍</span><b>${esc(s)}</b><em>${esc(i===0?fmt(row.fecha):(i===pi?nowLabel:'-'))}</em></div>`).join('')}
        <div class="entregaVehicle" style="left:${pct}%">🚛</div>
      </div>
      <div class="entregaSummary">
        <span><b>Actualizado:</b> ${esc(nowLabel)}</span>
        <span><b>Próximo hito:</b> ${esc(stages[Math.min(pi+1,stages.length-1)]||'-')}</span>
        <span><b>Estado:</b> ${esc(st.txt)}</span>
      </div>
    </article>`;
  }
  function fillFilters(rows){
    const defs=[['entregaFiltroCliente','cliente','Todos los clientes'],['entregaFiltroEmbarque','numero','Todos los embarques'],['entregaFiltroDestino','destino','Todos los destinos']];
    defs.forEach(([id,key,all])=>{
      const sel=document.getElementById(id); if(!sel)return; const cur=sel.value;
      const vals=[...new Set(rows.map(r=>txt(r[key],'')).filter(Boolean))].sort((a,b)=>String(a).localeCompare(String(b),'es',{numeric:true}));
      sel.innerHTML=`<option value="">${all}</option>`+vals.map(v=>`<option value="${esc(v)}">${key==='numero'?'Emb. ':''}${esc(v)}</option>`).join('');
      sel.value=vals.includes(cur)?cur:'';
      sel.onchange=()=>window.renderEntrega(false);
    });
  }
  window.renderEntrega=async function(force=false){
    ensureMenu(); ensurePanel(); setVersion();
    await ensureData(force);
    let rows=buildRows(); fillFilters(rows);
    const fc=low(document.getElementById('entregaFiltroCliente')?.value), fe=low(document.getElementById('entregaFiltroEmbarque')?.value), fd=low(document.getElementById('entregaFiltroDestino')?.value);
    rows=rows.filter(r=>(!fc||low(r.cliente)===fc)&&(!fe||low(r.numero)===fe)&&(!fd||low(r.destino)===fd));
    const box=document.getElementById('entregaCards'); if(!box)return;
    box.innerHTML=rows.length?rows.map(card).join(''):'<div class="glassPanel entregaEmpty">No hay embarques para el filtro seleccionado.</div>';
  };

  function injectCss(){
    if(document.getElementById('entrega-v2096-css'))return;
    const css=document.createElement('style'); css.id='entrega-v2096-css';
    css.textContent=`
      #entrega .sectionTitle{margin-bottom:16px}.entregaToolbar{display:grid;grid-template-columns:1fr 1fr 1fr auto;gap:14px;align-items:end;padding:18px 20px;margin-bottom:18px}.entregaToolbar label{display:flex;flex-direction:column;gap:7px;font-weight:800;color:#dce6f1}.entregaToolbar select{height:46px;border-radius:14px;border:1px solid rgba(148,163,184,.28);background:#152538;color:#fff;padding:0 14px;font-weight:800}.entregaRefreshBtn{height:46px;border-radius:14px;border:1px solid rgba(76,175,67,.7);background:#194f2b;color:#9dff7e;font-weight:900;padding:0 24px}.entregaCards{display:flex;flex-direction:column;gap:16px}.entregaCard{border:1px solid rgba(148,163,184,.20);background:linear-gradient(135deg,rgba(13,30,45,.96),rgba(9,21,34,.92));border-radius:18px;padding:18px 20px;box-shadow:0 14px 30px rgba(0,0,0,.20)}.entregaCard:nth-child(even){background:linear-gradient(135deg,rgba(24,45,62,.97),rgba(13,30,45,.92))}.entregaTop{display:grid;grid-template-columns:1.25fr repeat(5,1fr) auto;gap:14px;align-items:center;border-bottom:1px solid rgba(148,163,184,.18);padding-bottom:14px}.entregaEmb{display:flex;align-items:center;gap:12px}.entregaBoxIcon{width:42px;height:42px;border-radius:14px;display:grid;place-items:center;background:rgba(65,179,58,.22);border:1px solid rgba(82,255,96,.35);font-size:22px}.entregaEmb h3{margin:0;font-size:24px;line-height:1;color:#f8fafc}.entregaStatus{display:inline-block;margin-top:7px;padding:4px 9px;border-radius:7px;font-size:12px;font-weight:900}.entregaStatus.open{background:#155d2d;color:#9dff7e}.entregaStatus.done{background:#475569;color:#e5e7eb}.entregaStatus.planned{background:#0b4a8f;color:#93c5fd}.entregaStatus.customs{background:#6b4e12;color:#fde68a}.entregaMeta{border-left:1px solid rgba(148,163,184,.18);padding-left:14px;min-width:0}.entregaMeta b{display:block;font-size:12px;color:#65e65f;text-transform:uppercase;margin-bottom:4px}.entregaMeta span{display:block;color:#f1f5f9;font-size:15px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.entregaFlags{display:flex;gap:12px;font-size:30px;align-items:center}.entregaTimeline{position:relative;height:128px;margin-top:14px;padding:20px 24px 0}.entregaLine{position:absolute;left:28px;right:28px;top:52px;height:3px;background:rgba(226,232,240,.72);border-radius:10px;overflow:hidden}.entregaLine i{display:block;height:100%;background:linear-gradient(90deg,#22c55e,#84cc16,#f97316);border-radius:10px}.entregaStep{position:absolute;top:16px;transform:translateX(-50%);text-align:center;min-width:130px}.entregaStep .pin{display:block;font-size:17px;line-height:1}.entregaStep b{display:block;margin-top:3px;color:#f8fafc;font-size:13px;text-transform:uppercase;white-space:nowrap}.entregaStep em{display:block;margin-top:26px;color:#cbd5e1;font-size:12px;font-style:normal}.entregaStep::after{content:'';position:absolute;left:50%;top:32px;width:13px;height:13px;border-radius:50%;transform:translateX(-50%);border:2px solid #e2e8f0;background:#0b1b2b}.entregaStep.done::after{border-color:#22c55e;background:#22c55e}.entregaStep.current::after{border-color:#fb923c;background:#fb923c;box-shadow:0 0 0 5px rgba(249,115,22,.18)}.entregaVehicle{position:absolute;top:64px;transform:translateX(-50%);font-size:34px;filter:drop-shadow(0 8px 10px rgba(0,0,0,.45))}.entregaSummary{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:10px;padding:12px 14px;border-radius:14px;background:rgba(255,255,255,.04);border:1px solid rgba(148,163,184,.12);color:#dbeafe}.entregaSummary span{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.entregaSummary b{color:#9dff7e}.entregaEmpty{padding:24px;color:#cbd5e1;font-weight:800}@media(max-width:1100px){.entregaToolbar{grid-template-columns:1fr 1fr}.entregaTop{grid-template-columns:1fr 1fr 1fr}.entregaFlags{grid-column:1/-1}.entregaSummary{grid-template-columns:1fr}.entregaTimeline{overflow-x:auto}}
    `;
    document.head.appendChild(css);
  }
  ...
  if(typeof oldTab==='function'){
    window.tab=function(id){
      boot();
      const r=oldTab.apply(this,arguments);
      if(id==='entrega')setTimeout(()=>window.renderEntrega(false),30);
      return r;
    };
  }
  const oldRefresh=window.refresh;
