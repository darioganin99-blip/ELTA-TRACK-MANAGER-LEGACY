...
(function(){
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.121';});
})();
...
/* ===== V2.0.121 - FIX DEFINITIVO SOLO ENTREGAS: banderas reales dinamicas + version estable ===== */
(function(){
  const VERSION='2.0.121';
