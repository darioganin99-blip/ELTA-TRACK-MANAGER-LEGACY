...
/* ===== V2.0.90 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.90";
...
/* ===== V2.0.90 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.90 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.90 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.90 ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.90 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.90";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.90 MENU ROOT FIX - sin enforcers duplicados ===== */
(function(){
  const VERSION='2.0.90';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function setImp(el,p,v){ if(el) el.style.setProperty(p,v,'important'); }
  function fixVersion(){
  ...
  function normalizeMenu(){
    MENU.forEach(([id,icon,text])=>{
      const btn=document.querySelector(`.sideNav button[onclick*="${id}"]`);
      if(!btn) return;
      if(!btn.querySelector('.menuText') || btn.querySelector('.menuText').textContent!==text){
        btn.innerHTML=`<span class="menuIcon" aria-hidden="true">${icon}</span><span class="menuText">${text}</span>`;
      }
      btn.title=text;
  ...
  function applyMenu(){
    ...
    if(!collapsed){
      setImp(sidebar,'width','230px'); setImp(sidebar,'min-width','230px'); setImp(sidebar,'max-width','230px'); setImp(sidebar,'overflow','hidden');
      setImp(shell,'margin-left','230px');
    }else{
      setImp(sidebar,'width','72px'); setImp(sidebar,'min-width','72px'); setImp(sidebar,'max-width','72px'); setImp(sidebar,'overflow','hidden');
      setImp(shell,'margin-left','72px');
    }
    document.querySelectorAll('.sideNav button').forEach(btn=>{
      ...
      btn.querySelectorAll('.sideAlertBadge,.badgeCount,.alertBadge,.topAlertCount,#badgeAlertas,#alertCount').forEach(x=>x.remove());
      if(!collapsed){
        setImp(btn,'display','flex'); setImp(btn,'align-items','center'); setImp(btn,'justify-content','flex-start'); setImp(btn,'text-align','left'); setImp(btn,'padding','0 10px 0 34px'); setImp(btn,'height','38px'); setImp(btn,'min-height','38px'); setImp(btn,'width','100%'); setImp(btn,'max-width','100%'); setImp(btn,'overflow','hidden'); setImp(btn,'text-shadow','none'); setImp(btn,'filter','none'); setImp(btn,'animation','none');
        setImp(icon,'display','none'); setImp(icon,'width','0'); setImp(icon,'min-width','0'); setImp(icon,'opacity','0');
        setImp(txt,'position','static'); setImp(txt,'display','block'); setImp(txt,'text-align','left'); setImp(txt,'white-space','nowrap'); setImp(txt,'overflow','hidden'); setImp(txt,'text-overflow','clip'); setImp(txt,'font-size','14px'); setImp(txt,'font-weight','800'); setImp(txt,'line-height','1'); setImp(txt,'text-shadow','none'); setImp(txt,'filter','none'); setImp(txt,'animation','none'); setImp(txt,'transform','none'); setImp(txt,'box-shadow','none');
      }else{
        setImp(btn,'display','flex'); setImp(btn,'align-items','center'); setImp(btn,'justify-content','center'); setImp(btn,'padding','0'); setImp(btn,'height','40px'); setImp(btn,'min-height','40px'); setImp(btn,'width','52px'); setImp(btn,'max-width','52px'); setImp(btn,'overflow','hidden');
        setImp(txt,'display','none'); setImp(txt,'visibility','hidden'); setImp(txt,'opacity','0'); setImp(txt,'width','0');
        setImp(icon,'display','inline-flex'); setImp(icon,'visibility','visible'); setImp(icon,'opacity','1'); setImp(icon,'position','static'); setImp(icon,'width','30px'); setImp(icon,'min-width','30px'); setImp(icon,'height','30px'); setImp(icon,'align-items','center'); setImp(icon,'justify-content','center');
      }
    });
    fixVersion();
  }
  window.toggleSidebar=function(){ document.body.classList.toggle('sidebarCollapsed'); applyMenu(); setTimeout(applyMenu,60); };
  const previousTab=window.tab;
  if(typeof previousTab==='function'){
    window.tab=function(){ const r=previousTab.apply(this,arguments); applyMenu(); setTimeout(applyMenu,60); return r; };
  }
  document.addEventListener('DOMContentLoaded',()=>{document.body.classList.remove('sidebarCollapsed'); applyMenu(); setTimeout(applyMenu,300);});
  window.addEventListener('load',()=>{applyMenu(); setTimeout(applyMenu,500);});
  applyMenu();
})();
