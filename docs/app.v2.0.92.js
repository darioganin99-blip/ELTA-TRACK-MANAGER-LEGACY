...
/* ===== V2.0.92 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.92";
...
/* ===== V2.0.92 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.92 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.92 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.92 ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.92";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.92 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.92 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.92';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.92';});
})();


/* ===== V2.0.92 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.92";
...
/* ===== V2.0.92 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.92";
...
/* ===== V2.0.92 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.92 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.92 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.92';
...
/* ===== V2.0.92 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.92';
...
/* ===== V2.0.92 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.92';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.92 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.92';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.92 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.92 - MENU LATERAL ESTABLE FINAL ===== */
(function(){
  const VERSION='2.0.92';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function installCss(){
    let css=document.getElementById('elta-menu-stable-final-291');
    if(!css){css=document.createElement('style');css.id='elta-menu-stable-final-291';document.head.appendChild(css);}
    css.textContent=`
      body:not(.sidebarCollapsed) .sidebar{width:230px!important;min-width:230px!important;max-width:230px!important;padding:14px 14px 12px!important;overflow:hidden!important;box-sizing:border-box!important;}
      body:not(.sidebarCollapsed) .dashboardShell{margin-left:230px!important;}
      body:not(.sidebarCollapsed) .brandBox{height:88px!important;padding:0 6px 8px!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:8px!important;}
      body:not(.sidebarCollapsed) .brandBox img{width:122px!important;max-width:122px!important;height:auto!important;object-fit:contain!important;}
      body:not(.sidebarCollapsed) .brandDivider{display:block!important;width:82%!important;margin:0 auto!important;}
      body:not(.sidebarCollapsed) .sideNav{display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:2px!important;margin-top:8px!important;}
      body:not(.sidebarCollapsed) .sideNav button{width:100%!important;min-width:100%!important;max-width:100%!important;height:38px!important;min-height:38px!important;margin:0!important;padding:0 8px 0 34px!important;box-sizing:border-box!important;border-radius:12px!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;text-align:left!important;white-space:nowrap!important;overflow:hidden!important;gap:0!important;font-family:Arial,Helvetica,sans-serif!important;font-size:14px!important;font-weight:800!important;line-height:38px!important;letter-spacing:0!important;color:rgba(255,255,255,.88)!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;}
      body:not(.sidebarCollapsed) .sideNav button .menuIcon{display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;min-width:0!important;max-width:0!important;overflow:hidden!important;}
      body:not(.sidebarCollapsed) .sideNav button .menuText{display:block!important;position:static!important;flex:0 1 auto!important;width:auto!important;max-width:100%!important;margin:0!important;padding:0!important;text-align:left!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;color:inherit!important;font:inherit!important;line-height:38px!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;box-shadow:none!important;}
      body:not(.sidebarCollapsed) .sideNav button.active{background:linear-gradient(90deg,rgba(76,198,63,.78),rgba(76,198,63,.22))!important;border-left:3px solid #6cff4a!important;box-shadow:none!important;color:#fff!important;}
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"],body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .menuText{box-shadow:none!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;}
      body:not(.sidebarCollapsed) .sideNav .sideAlertBadge,body:not(.sidebarCollapsed) .sideNav .badgeCount,body:not(.sidebarCollapsed) .sideNav .alertBadge,body:not(.sidebarCollapsed) .sideNav .topAlertCount{display:none!important;visibility:hidden!important;opacity:0!important;}
      body.sidebarCollapsed .sidebar{width:72px!important;min-width:72px!important;max-width:72px!important;padding:14px 8px!important;overflow:hidden!important;box-sizing:border-box!important;}
      body.sidebarCollapsed .dashboardShell{margin-left:72px!important;}
      body.sidebarCollapsed .brandBox{height:66px!important;padding:0!important;display:flex!important;align-items:center!important;justify-content:center!important;}
      body.sidebarCollapsed .brandBox img{width:48px!important;max-width:48px!important;height:auto!important;}
      body.sidebarCollapsed .brandDivider{display:none!important;}
      body.sidebarCollapsed .sideNav{display:flex!important;flex-direction:column!important;align-items:center!important;width:100%!important;gap:6px!important;}
      body.sidebarCollapsed .sideNav button{width:52px!important;min-width:52px!important;max-width:52px!important;height:40px!important;min-height:40px!important;padding:0!important;margin:0!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;text-align:center!important;border-radius:12px!important;}
      body.sidebarCollapsed .sideNav button .menuText{display:none!important;visibility:hidden!important;width:0!important;min-width:0!important;max-width:0!important;opacity:0!important;}
      body.sidebarCollapsed .sideNav button .menuIcon{display:inline-flex!important;visibility:visible!important;opacity:1!important;align-items:center!important;justify-content:center!important;width:30px!important;min-width:30px!important;max-width:30px!important;height:30px!important;font-size:20px!important;}
    `;
  }
  function normalizeMenu(){
    try{
      ...
      MENU.forEach(([id,icon,text])=>{
        ...
        if(!ic || !tx){btn.innerHTML='<span class="menuIcon" aria-hidden="true"></span><span class="menuText"></span>';ic=btn.querySelector('.menuIcon');tx=btn.querySelector('.menuText');}
        ic.textContent=icon;
        tx.textContent=text;
        btn.title=text;
  ...
  window.toggleSidebar=function(){document.body.classList.toggle('sidebarCollapsed');normalizeMenu();};
  const oldTab=window.tab;
  if(typeof oldTab==='function'){
    window.tab=function(){const r=oldTab.apply(this,arguments);normalizeMenu();return r;};
  }
  document.addEventListener('DOMContentLoaded',()=>{document.body.classList.remove('sidebarCollapsed');normalizeMenu();});
  window.addEventListener('load',normalizeMenu);
  normalizeMenu();
})();


/* ===== V2.0.92 - BLOQUE FINAL UNICO MENU: estabiliza alineacion izquierda ===== */
(function(){
  const VERSION='2.0.92';
  const MENU=[
    ['dash','🏠','Torre de Control'],
  ...
  function css(){
    let s=document.getElementById('elta-menu-v2092-final');
    if(!s){s=document.createElement('style');s.id='elta-menu-v2092-final';document.head.appendChild(s);}
    s.textContent=`
      ...
      html body:not(.sidebarCollapsed) .sideNav{display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:6px!important;margin-top:10px!important;}
      html body:not(.sidebarCollapsed) .sideNav button,html body:not(.sidebarCollapsed) .sideNav button.active,html body:not(.sidebarCollapsed) .sideNav button:hover,html body:not(.sidebarCollapsed) .sideNav button:focus{width:100%!important;min-width:0!important;max-width:100%!important;height:38px!important;min-height:38px!important;max-height:38px!important;margin:0!important;padding:0 10px 0 34px!important;box-sizing:border-box!important;display:block!important;text-align:left!important;justify-content:unset!important;align-items:unset!important;place-items:unset!important;white-space:nowrap!important;overflow:hidden!important;border-radius:12px!important;font-family:Arial,Helvetica,sans-serif!important;font-size:14px!important;font-weight:800!important;line-height:38px!important;letter-spacing:0!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;}
      html body:not(.sidebarCollapsed) .sideNav button.active{background:linear-gradient(90deg,rgba(76,198,63,.78),rgba(76,198,63,.22))!important;border-left:3px solid #6cff4a!important;box-shadow:none!important;color:#fff!important;}
      html body:not(.sidebarCollapsed) .sideNav button .menuIcon,html body:not(.sidebarCollapsed) .sideNav button span.menuIcon,html body:not(.sidebarCollapsed) .sideNav button>span:first-child:not(.menuText){display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;min-width:0!important;max-width:0!important;height:0!important;margin:0!important;padding:0!important;overflow:hidden!important;}
      html body:not(.sidebarCollapsed) .sideNav button .menuText,html body:not(.sidebarCollapsed) .sideNav button.active .menuText,html body:not(.sidebarCollapsed) .sideNav button:hover .menuText,html body:not(.sidebarCollapsed) .sideNav button:focus .menuText{display:block!important;position:static!important;width:100%!important;max-width:100%!important;height:38px!important;margin:0!important;padding:0!important;text-align:left!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;color:inherit!important;font:inherit!important;line-height:38px!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;box-shadow:none!important;}
      html body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"],html body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"].active,html body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .menuText{text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;}
      ...
      html body.sidebarCollapsed .sideNav{display:flex!important;flex-direction:column!important;align-items:center!important;gap:6px!important;}
      html body.sidebarCollapsed .sideNav button,html body.sidebarCollapsed .sideNav button.active{width:52px!important;min-width:52px!important;max-width:52px!important;height:40px!important;min-height:40px!important;padding:0!important;margin:0!important;display:flex!important;align-items:center!important;justify-content:center!important;text-align:center!important;overflow:hidden!important;border-radius:12px!important;}
      html body.sidebarCollapsed .sideNav button .menuText,html body.sidebarCollapsed .adminBox div,html body.sidebarCollapsed .logoutBtn{display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;min-width:0!important;max-width:0!important;overflow:hidden!important;}
  ...
  function normalize(){
    try{
      ...
      MENU.forEach(([id,icon,text])=>{
        ...
        let ic=btn.querySelector('.menuIcon');
        let tx=btn.querySelector('.menuText');
        if(!ic || !tx || btn.childNodes.length>2){
          btn.innerHTML='<span class="menuIcon" aria-hidden="true"></span><span class="menuText"></span>';
          ic=btn.querySelector('.menuIcon'); tx=btn.querySelector('.menuText');
        }
  ...
  const oldToggle=window.toggleSidebar;
  window.toggleSidebar=function(){
    if(typeof oldToggle==='function') oldToggle.apply(this,arguments); else document.body.classList.toggle('sidebarCollapsed');
    normalize();
  };
  const oldTab=window.tab;
  if(typeof oldTab==='function'){
    window.tab=function(){const r=oldTab.apply(this,arguments); normalize(); return r;};
  }
  let pending=false;
  function schedule(){if(pending)return; pending=true; requestAnimationFrame(()=>{pending=false; normalize();});}
  document.addEventListener('DOMContentLoaded',()=>{document.body.classList.remove('sidebarCollapsed'); normalize(); const nav=document.querySelector('.sideNav'); if(nav){new MutationObserver(schedule).observe(nav,{childList:true,subtree:true,attributes:true});}});
