...
/* ===== V2.0.93 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.93";
...
/* ===== V2.0.93 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V2.0.93 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.93 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function normalizeMenu(){
    const map=[['dash','🏠','Torre de Control'],['transitos','🚚','Tránsitos'],['mapa','📍','Seguimiento'],['clima','🌦️','Clima'],['unidades','🚛','Unidades / Choferes'],['alertas','🔔','Alertas'],['clientes','🏢','Clientes / Destinos'],['abm','⚙️','Configuración']];
...
/* ===== V2.0.93 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.93 ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.93";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.93 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.93 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.93 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.93';
...
/* ===== V2.0.93 - Normalizacion definitiva SOLO menu lateral ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function pendingCount(){
    try{ if(typeof window.pendingAlertsCount==='function') return Number(window.pendingAlertsCount())||0; }catch(e){}
    try{ if(typeof window.allOpenAlertRows35==='function') return window.allOpenAlertRows35().filter(r=>!r.verified).length; }catch(e){}
    try{
      const rows=Array.isArray(window.__alertRowsById)?window.__alertRowsById:Object.values(window.__alertRowsById||{});
      if(rows.length) return rows.filter(r=>!r.verified).length;
    }catch(e){}
  ...
  function normalizeMenu(){
    defs.forEach(([id,icon,text])=>{
      ...
      btn.querySelector('.menuIcon').textContent=icon;
      btn.querySelector('.menuText').textContent=text;
      btn.title=text;
      if(id==='alertas'){
        if(!badge){ badge=document.createElement('span'); badge.className='sideAlertBadge'; }
        btn.appendChild(badge);
      }
    });
    const alertBtn=[...document.querySelectorAll('.sideNav button')].find(b=>(b.getAttribute('onclick')||'').includes('alertas'));
    if(alertBtn){
      const n=pendingCount();
      let badge=alertBtn.querySelector('.sideAlertBadge');
      if(!badge){ badge=document.createElement('span'); badge.className='sideAlertBadge'; alertBtn.appendChild(badge); }
      badge.textContent=n>0?String(n):'';
      badge.style.display=n>0?'inline-flex':'none';
      alertBtn.classList.toggle('hasPendingAlerts',n>0);
      alertBtn.classList.toggle('menuAlertPending',n>0);
      ['headerAlertCount','alertCount','badgeAlertas','kal'].forEach(id=>{const e=document.getElementById(id); if(e) e.textContent=String(n);});
    }
    versionLabels();
  }
  window.normalizeSideMenuV241=normalizeMenu;
  ['DOMContentLoaded','load'].forEach(ev=>window.addEventListener(ev,()=>{setTimeout(normalizeMenu,0);setTimeout(normalizeMenu,250);setTimeout(normalizeMenu,900);}));
  setInterval(normalizeMenu,900);
  const oldTab=window.tab;
  if(typeof oldTab==='function') window.tab=function(){const r=oldTab.apply(this,arguments);setTimeout(normalizeMenu,0);return r;};
  const oldRender=window.renderBadge;
  window.renderBadge=function(){try{if(typeof oldRender==='function')oldRender.apply(this,arguments);}catch(e){} setTimeout(normalizeMenu,0);};
})();



/* ===== V2.0.93 - Fix definitivo menú lateral, hamburguesa y campana sin contador ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function pendingCountReal(){
    try{
      if(typeof window.allOpenAlertRows35==='function'){
        const rows=window.allOpenAlertRows35()||[];
        return rows.filter(r=>!r.verified && !(r.a && (r.a.verified || r.a.verificada || r.a.estado==='verificada'))).length;
      }
    }catch(e){}
    try{
      const src=window.__alertRowsById;
      const rows=Array.isArray(src)?src:Object.values(src||{});
      if(rows.length) return rows.filter(r=>!r.verified && !(r.a && (r.a.verified || r.a.verificada || r.a.estado==='verificada'))).length;
    }catch(e){}
    try{ if(typeof window.pendingAlertsOpenRowsV1250==='function') return (window.pendingAlertsOpenRowsV1250()||[]).length; }catch(e){}
    try{ if(typeof window.pendingAlertsCount==='function') return Number(window.pendingAlertsCount())||0; }catch(e){}
    return 0;
  }

  function normalizeSideMenu(){
    menuDefs.forEach(([id,icon,text])=>{
      const btn=[...document.querySelectorAll('.sideNav button')].find(b=>(b.getAttribute('onclick')||'').includes(id));
      if(!btn) return;
      let iconEl=btn.querySelector('.menuIcon');
      let textEl=btn.querySelector('.menuText');
      if(!iconEl || !textEl){
        btn.innerHTML='<span class="menuIcon" aria-hidden="true"></span><span class="menuText"></span>';
      ...
      btn.title=text;
      // El menú no debe mostrar número de alarmas pendientes.
      btn.querySelectorAll('.sideAlertBadge,.badgeCount,.alertBadge,.topAlertCount,#badgeAlertas,#alertCount').forEach(x=>x.remove());
    });

    const n=pendingCountReal();
    const alertBtn=[...document.querySelectorAll('.sideNav button')].find(b=>(b.getAttribute('onclick')||'').includes('alertas'));
    if(alertBtn){
      alertBtn.classList.toggle('menuAlertPending', n>0);
      alertBtn.classList.toggle('hasPendingAlerts', n>0);
    }
    // Los contadores fuera del menú sí se mantienen sincronizados.
    ['headerAlertCount','alertCount','badgeAlertas','kal'].forEach(id=>{
  ...
  // Reemplazo real del botón hamburguesa: no llama a funciones viejas para evitar doble toggle.
  window.toggleSidebar=function(){
  ...
  window.normalizeSideMenuV243=normalizeSideMenu;
  ...
  const oldRenderBadge=window.renderBadge;
  window.renderBadge=function(){
    try{ if(typeof oldRenderBadge==='function') oldRenderBadge.apply(this,arguments); }catch(e){}
    setTimeout(normalizeSideMenu,0);
  };

  ['DOMContentLoaded','load'].forEach(ev=>window.addEventListener(ev,()=>{
    setTimeout(normalizeSideMenu,0);
    setTimeout(normalizeSideMenu,300);
    setTimeout(normalizeSideMenu,1000);
  }));
  setInterval(normalizeSideMenu,500);
})();


/* ===== V2.0.93 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.93 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.93';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.93';});
})();


/* ===== V2.0.93 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.93";
...
/* ===== V2.0.93 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.93";
...
/* ===== V2.0.93 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.93 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.93 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  window.openCargasEmbarqueV267=async function(numero){
    ...
    modal.innerHTML=`<div class="cargasModalV267">
      ...
      <div class="tableWrap"><table class="embarquesTable cargasTableV267"><thead><tr><th>Factura N.º</th><th>MIC</th><th>CRT</th><th>Volumen</th><th>Flota</th></tr></thead><tbody>${list.map(c=>`<tr><td>${E(c.factura||c.facturaNumero||'-')}</td><td>${E(c.mic||c.MIC||'-')}</td><td>${E(c.crt||c.CRT||'-')}</td><td>${E(c.volumen||'-')}</td><td>${E(c.flota||'-')}</td></tr>`).join('')||'<tr><td colspan="5" class="emptyRow">Sin cargas asociadas.</td></tr>'}</tbody></table></div>
...
/* ===== V2.0.93 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.93';
...
/* ===== V2.0.93 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.93';
...
/* ===== V2.0.93 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.93';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.93 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.93';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.93 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.93 - Menu lateral: alineacion real sin efectos en Alertas ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  function setVersion286(){
    try{
      document.querySelectorAll('span,small,p,div').forEach(el=>{
        if(el.childElementCount===0 && /Versi[oó]n\s+\d+\.\d+\.\d+/.test(el.textContent||'')){
          el.textContent=(el.textContent||'').replace(/Versi[oó]n\s+\d+\.\d+\.\d+/g,'Versión '+VERSION);
  ...
  function injectMenuCss286(){
    let css=document.getElementById('v2086-menu-left-final');
    if(!css){
      css=document.createElement('style');
      css.id='v2086-menu-left-final';
      document.head.appendChild(css);
    }
    css.textContent=`
      body:not(.sidebarCollapsed) .sidebar{width:230px!important;min-width:230px!important;max-width:230px!important;padding:14px 12px!important;overflow:hidden!important;}
      body:not(.sidebarCollapsed) .dashboardShell{margin-left:230px!important;}
      body:not(.sidebarCollapsed) .brandBox{height:78px!important;padding:0 10px 8px!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;}
      body:not(.sidebarCollapsed) .brandBox img{width:124px!important;max-width:124px!important;height:auto!important;object-fit:contain!important;}
      body:not(.sidebarCollapsed) .brandDivider{width:84%!important;margin:0 auto!important;}
      body:not(.sidebarCollapsed) .sideNav{display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:4px!important;margin-top:8px!important;width:100%!important;}
      body:not(.sidebarCollapsed) .sideNav button{box-sizing:border-box!important;width:100%!important;min-width:0!important;max-width:none!important;min-height:38px!important;height:38px!important;padding:7px 16px 7px 26px!important;margin:0!important;border-radius:10px!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;text-align:left!important;gap:0!important;overflow:hidden!important;white-space:nowrap!important;font-family:Arial,Helvetica,sans-serif!important;font-size:14px!important;font-weight:800!important;line-height:1!important;letter-spacing:0!important;text-shadow:none!important;filter:none!important;}
      body:not(.sidebarCollapsed) .sideNav button .menuIcon{display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;min-width:0!important;max-width:0!important;flex:0 0 0!important;margin:0!important;padding:0!important;overflow:hidden!important;}
      body:not(.sidebarCollapsed) .sideNav button .menuText{display:block!important;visibility:visible!important;opacity:1!important;flex:1 1 auto!important;width:100%!important;min-width:0!important;max-width:none!important;margin:0!important;padding:0!important;text-align:left!important;white-space:nowrap!important;overflow:visible!important;text-overflow:clip!important;color:rgba(255,255,255,.88)!important;font-family:Arial,Helvetica,sans-serif!important;font-size:14px!important;font-weight:800!important;line-height:1!important;text-shadow:none!important;filter:none!important;transform:none!important;animation:none!important;box-shadow:none!important;}
      body:not(.sidebarCollapsed) .sideNav button.active{background:linear-gradient(90deg,rgba(76,198,63,.72),rgba(76,198,63,.20))!important;color:#fff!important;border-left:3px solid #6cff4a!important;box-shadow:none!important;filter:none!important;text-shadow:none!important;}
      body:not(.sidebarCollapsed) .sideNav button.active .menuText{color:#fff!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;}
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"],
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"].menuAlertPending,
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"].hasPendingAlerts,
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"]:not(.active){background:transparent!important;border:0!important;border-left:0!important;box-shadow:none!important;outline:0!important;filter:none!important;animation:none!important;color:rgba(255,255,255,.88)!important;}
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"].active{background:linear-gradient(90deg,rgba(76,198,63,.72),rgba(76,198,63,.20))!important;color:#fff!important;border-left:3px solid #6cff4a!important;box-shadow:none!important;outline:0!important;filter:none!important;}
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .menuText,
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"].active .menuText{color:inherit!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;box-shadow:none!important;}
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .menuIcon,
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .sideAlertBadge,
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .badgeCount,
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .alertBadge,
      body:not(.sidebarCollapsed) .sideNav button[onclick*="alertas"] .topAlertCount{display:none!important;visibility:hidden!important;opacity:0!important;filter:none!important;animation:none!important;box-shadow:none!important;}
      body.sidebarCollapsed .sideNav button .menuIcon{display:inline-flex!important;visibility:visible!important;opacity:1!important;width:32px!important;min-width:32px!important;max-width:32px!important;flex:0 0 32px!important;align-items:center!important;justify-content:center!important;}
      body.sidebarCollapsed .sideNav button .menuText{display:none!important;visibility:hidden!important;opacity:0!important;}
    `;
  }
  function applyMenu286(){
    try{
      injectMenuCss286();
      document.querySelectorAll('.sideNav button').forEach(btn=>{
        ...
        const text=btn.querySelector('.menuText');
        if(text){text.style.textAlign='left';text.style.textShadow='none';text.style.filter='none';}
        if((btn.getAttribute('onclick')||'').includes('alertas') && !btn.classList.contains('active')){
  ...
  document.addEventListener('DOMContentLoaded',()=>{applyMenu286();setTimeout(applyMenu286,250);setTimeout(applyMenu286,1000);});
  window.addEventListener('load',()=>{applyMenu286();setTimeout(applyMenu286,500);});
  setInterval(applyMenu286,2000);
  applyMenu286();
})();

/* ===== V2.0.93 - ENFORCER RAIZ MENU LATERAL =====
   Evita que scripts previos vuelvan a centrar textos o a aplicar efectos al texto de Alertas. */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function applyRootMenuFix(){
    try{
      const body=document.body;
      const expanded=!body.classList.contains('sidebarCollapsed');
      const sidebar=document.querySelector('.sidebar');
      const shell=document.querySelector('.dashboardShell');
      const nav=document.querySelector('.sideNav');
      if(expanded){
        if(sidebar){ imp(sidebar,'width','230px'); imp(sidebar,'min-width','230px'); imp(sidebar,'max-width','230px'); imp(sidebar,'padding','14px 12px'); imp(sidebar,'overflow','hidden'); }
        if(shell){ imp(shell,'margin-left','230px'); }
        if(nav){ imp(nav,'align-items','stretch'); imp(nav,'gap','4px'); imp(nav,'width','100%'); }
      }
      document.querySelectorAll('.sideNav button').forEach(btn=>{
        const onclick=btn.getAttribute('onclick')||'';
        const isAlert=onclick.includes('alertas');
        if(expanded){
          imp(btn,'position','relative'); imp(btn,'box-sizing','border-box'); imp(btn,'width','100%'); imp(btn,'min-width','100%'); imp(btn,'max-width','100%');
          imp(btn,'height','38px'); imp(btn,'min-height','38px'); imp(btn,'padding','0'); imp(btn,'margin','0'); imp(btn,'display','block');
          imp(btn,'text-align','left'); imp(btn,'justify-content','initial'); imp(btn,'align-items','initial'); imp(btn,'gap','0'); imp(btn,'line-height','38px');
          imp(btn,'text-shadow','none'); imp(btn,'filter','none'); imp(btn,'transform','none'); imp(btn,'animation','none');
          if(isAlert){ imp(btn,'box-shadow','none'); imp(btn,'text-shadow','none'); imp(btn,'filter','none'); imp(btn,'animation','none'); }
          const icon=btn.querySelector('.menuIcon');
          if(icon){ imp(icon,'display','none'); imp(icon,'visibility','hidden'); imp(icon,'opacity','0'); imp(icon,'width','0'); imp(icon,'min-width','0'); imp(icon,'max-width','0'); imp(icon,'flex','0 0 0'); }
          const txt=btn.querySelector('.menuText');
          if(txt){
            imp(txt,'position','absolute'); imp(txt,'left','26px'); imp(txt,'top','0'); imp(txt,'right','10px'); imp(txt,'height','38px'); imp(txt,'line-height','38px');
            imp(txt,'display','block'); imp(txt,'visibility','visible'); imp(txt,'opacity','1'); imp(txt,'width','auto'); imp(txt,'max-width','none');
            imp(txt,'margin','0'); imp(txt,'padding','0'); imp(txt,'text-align','left'); imp(txt,'white-space','nowrap'); imp(txt,'overflow','hidden'); imp(txt,'text-overflow','clip');
            imp(txt,'font-size','14px'); imp(txt,'font-weight','800'); imp(txt,'letter-spacing','0'); imp(txt,'text-shadow','none'); imp(txt,'filter','none'); imp(txt,'transform','none'); imp(txt,'animation','none'); imp(txt,'box-shadow','none');
            if(isAlert){ imp(txt,'text-shadow','none'); imp(txt,'filter','none'); imp(txt,'animation','none'); imp(txt,'transform','none'); imp(txt,'box-shadow','none'); }
          }
          btn.querySelectorAll('.sideAlertBadge,.badgeCount,.alertBadge,.topAlertCount').forEach(b=>{imp(b,'display','none'); imp(b,'visibility','hidden'); imp(b,'opacity','0');});
        }else{
          imp(btn,'display','flex'); imp(btn,'align-items','center'); imp(btn,'justify-content','center'); imp(btn,'width','52px'); imp(btn,'min-width','52px'); imp(btn,'max-width','52px');
          const icon=btn.querySelector('.menuIcon'); if(icon){ imp(icon,'display','inline-flex'); imp(icon,'visibility','visible'); imp(icon,'opacity','1'); imp(icon,'position','static'); }
          const txt=btn.querySelector('.menuText'); if(txt){ imp(txt,'display','none'); imp(txt,'visibility','hidden'); imp(txt,'opacity','0'); }
        }
      });
      fixVersions();
    }catch(e){}
  ...
  const oldTab=window.tab;
  if(typeof oldTab==='function'){
    window.tab=function(){ const r=oldTab.apply(this,arguments); setTimeout(applyRootMenuFix,0); setTimeout(applyRootMenuFix,120); return r; };
  }
  const oldToggle=window.toggleSidebar;
  if(typeof oldToggle==='function'){
    window.toggleSidebar=function(){ const r=oldToggle.apply(this,arguments); setTimeout(applyRootMenuFix,0); setTimeout(applyRootMenuFix,120); return r; };
  }
  document.addEventListener('DOMContentLoaded',()=>{applyRootMenuFix(); setTimeout(applyRootMenuFix,250); setTimeout(applyRootMenuFix,1000);});
  window.addEventListener('load',()=>{applyRootMenuFix(); setTimeout(applyRootMenuFix,500);});
  setInterval(applyRootMenuFix,1000);
  applyRootMenuFix();
})();

/* ===== V2.0.93 - FIX RAIZ MENU ESTABLE ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  const MENU=[
    ['dash','🏠','Torre de Control'],['transitos','🚚','Tránsitos'],['mapa','📍','Seguimiento'],['clima','🌦️','Clima'],
    ['unidades','🚛','Unidades / Choferes'],['alertas','🔔','Alertas'],['embarques','📦','Embarques'],['clientes','🏢','Clientes / Destinos'],['abm','⚙️','Configuración']
  ];
  ...
  function normalizeMenuMarkup(){
    MENU.forEach(([id,icon,text])=>{
      const btn=document.querySelector(`.sideNav button[onclick*="${id}"]`);
      if(!btn) return;
      const currentText=(btn.querySelector('.menuText')||{}).textContent;
      if(currentText!==text || !btn.querySelector('.menuIcon')){
        btn.innerHTML=`<span class="menuIcon" aria-hidden="true">${icon}</span><span class="menuText">${text}</span>`;
      }
      btn.title=text;
      btn.querySelectorAll('.sideAlertBadge,.badgeCount,.alertBadge,.topAlertCount,#badgeAlertas,#alertCount').forEach(x=>x.remove());
  ...
  function applyStableMenu(){
    try{
      ...
      const sidebar=document.querySelector('.sidebar');
      const shell=document.querySelector('.dashboardShell');
      const brand=document.querySelector('.brandBox');
      const logo=document.querySelector('.brandBox img');
      const divider=document.querySelector('.brandDivider');
      const nav=document.querySelector('.sideNav');
      if(!collapsed){
        if(sidebar){setImportant(sidebar,'width','230px');setImportant(sidebar,'min-width','230px');setImportant(sidebar,'max-width','230px');setImportant(sidebar,'padding','14px 14px 12px');setImportant(sidebar,'overflow','hidden');setImportant(sidebar,'box-sizing','border-box');}
        if(shell){setImportant(shell,'margin-left','230px');}
        if(brand){setImportant(brand,'height','88px');setImportant(brand,'padding','0 6px 8px');setImportant(brand,'display','flex');setImportant(brand,'flex-direction','column');setImportant(brand,'align-items','center');setImportant(brand,'justify-content','center');setImportant(brand,'gap','8px');}
        if(logo){setImportant(logo,'width','122px');setImportant(logo,'max-width','122px');}
        if(divider){setImportant(divider,'display','block');setImportant(divider,'width','82%');}
        if(nav){setImportant(nav,'display','flex');setImportant(nav,'flex-direction','column');setImportant(nav,'gap','2px');setImportant(nav,'align-items','stretch');setImportant(nav,'width','100%');}
      }else{
        if(sidebar){setImportant(sidebar,'width','72px');setImportant(sidebar,'min-width','72px');setImportant(sidebar,'max-width','72px');setImportant(sidebar,'padding','14px 8px');setImportant(sidebar,'overflow','hidden');setImportant(sidebar,'box-sizing','border-box');}
        if(shell){setImportant(shell,'margin-left','72px');}
        if(brand){setImportant(brand,'height','66px');setImportant(brand,'padding','0');setImportant(brand,'align-items','center');setImportant(brand,'justify-content','center');}
        if(logo){setImportant(logo,'width','48px');setImportant(logo,'max-width','48px');}
        if(divider){setImportant(divider,'display','none');}
        if(nav){setImportant(nav,'display','flex');setImportant(nav,'flex-direction','column');setImportant(nav,'gap','6px');setImportant(nav,'align-items','center');setImportant(nav,'width','100%');}
      }
      document.querySelectorAll('.sideNav button').forEach(btn=>{
        const isAlert=(btn.getAttribute('onclick')||'').includes('alertas');
        const icon=btn.querySelector('.menuIcon');
        const txt=btn.querySelector('.menuText');
        btn.querySelectorAll('.sideAlertBadge,.badgeCount,.alertBadge,.topAlertCount').forEach(x=>x.remove());
        if(!collapsed){
          setImportant(btn,'position','relative');setImportant(btn,'display','block');setImportant(btn,'box-sizing','border-box');setImportant(btn,'width','100%');setImportant(btn,'min-width','100%');setImportant(btn,'max-width','100%');setImportant(btn,'height','36px');setImportant(btn,'min-height','36px');setImportant(btn,'padding','0');setImportant(btn,'margin','0');setImportant(btn,'overflow','hidden');setImportant(btn,'text-align','left');setImportant(btn,'justify-content','initial');setImportant(btn,'align-items','initial');setImportant(btn,'gap','0');setImportant(btn,'font-size','14px');setImportant(btn,'font-weight','800');setImportant(btn,'line-height','36px');setImportant(btn,'text-shadow','none');setImportant(btn,'filter','none');setImportant(btn,'transform','none');setImportant(btn,'animation','none');
          if(icon){setImportant(icon,'display','none');setImportant(icon,'visibility','hidden');setImportant(icon,'opacity','0');setImportant(icon,'width','0');setImportant(icon,'min-width','0');setImportant(icon,'max-width','0');setImportant(icon,'flex','0 0 0');}
          if(txt){setImportant(txt,'position','absolute');setImportant(txt,'left','32px');setImportant(txt,'right','8px');setImportant(txt,'top','0');setImportant(txt,'height','36px');setImportant(txt,'display','block');setImportant(txt,'visibility','visible');setImportant(txt,'opacity','1');setImportant(txt,'width','auto');setImportant(txt,'max-width','none');setImportant(txt,'margin','0');setImportant(txt,'padding','0');setImportant(txt,'text-align','left');setImportant(txt,'font-size','14px');setImportant(txt,'font-weight','800');setImportant(txt,'line-height','36px');setImportant(txt,'white-space','nowrap');setImportant(txt,'overflow','hidden');setImportant(txt,'text-overflow','clip');setImportant(txt,'text-shadow','none');setImportant(txt,'filter','none');setImportant(txt,'transform','none');setImportant(txt,'animation','none');setImportant(txt,'box-shadow','none');}
          if(isAlert){setImportant(btn,'text-shadow','none');setImportant(btn,'filter','none');setImportant(btn,'animation','none');setImportant(btn,'box-shadow','none');}
        }else{
          setImportant(btn,'width','52px');setImportant(btn,'min-width','52px');setImportant(btn,'max-width','52px');setImportant(btn,'height','40px');setImportant(btn,'min-height','40px');setImportant(btn,'padding','0');setImportant(btn,'display','flex');setImportant(btn,'align-items','center');setImportant(btn,'justify-content','center');setImportant(btn,'gap','0');setImportant(btn,'overflow','hidden');setImportant(btn,'text-align','center');
          if(txt){setImportant(txt,'display','none');setImportant(txt,'visibility','hidden');setImportant(txt,'width','0');setImportant(txt,'min-width','0');setImportant(txt,'max-width','0');setImportant(txt,'opacity','0');}
          if(icon){setImportant(icon,'display','inline-flex');setImportant(icon,'visibility','visible');setImportant(icon,'opacity','1');setImportant(icon,'position','static');setImportant(icon,'align-items','center');setImportant(icon,'justify-content','center');setImportant(icon,'flex','0 0 30px');setImportant(icon,'width','30px');setImportant(icon,'min-width','30px');setImportant(icon,'max-width','30px');setImportant(icon,'height','30px');setImportant(icon,'font-size','20px');}
        }
      });
      fixVersion();
    }catch(e){}
  ...
  window.toggleSidebar=function(){
    document.body.classList.toggle('sidebarCollapsed');
    applyStableMenu();
    setTimeout(applyStableMenu,50);
    setTimeout(applyStableMenu,200);
  };
  const oldTab=window.tab;
  if(typeof oldTab==='function'){
    window.tab=function(){ const r=oldTab.apply(this,arguments); applyStableMenu(); setTimeout(applyStableMenu,80); return r; };
  }
  document.addEventListener('DOMContentLoaded',()=>{document.body.classList.remove('sidebarCollapsed');applyStableMenu();setTimeout(applyStableMenu,250);setTimeout(applyStableMenu,1000);});
  window.addEventListener('load',()=>{applyStableMenu();setTimeout(applyStableMenu,500);});
  setInterval(applyStableMenu,250);
  applyStableMenu();
})();


/* ===== V2.0.93 - FIX RAIZ MENU LATERAL: ALINEACION ESTABLE ===== */
(function(){
  const VERSION='2.0.93';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
  ...
  function ensureStyle(){
    let st=document.getElementById('elta-menu-v2093-root-lock');
    if(!st){st=document.createElement('style');st.id='elta-menu-v2093-root-lock';document.head.appendChild(st);}
    st.textContent=`
      html body:not(.sidebarCollapsed) aside.sidebar{width:230px!important;min-width:230px!important;max-width:230px!important;padding:14px 14px 12px!important;overflow:hidden!important;box-sizing:border-box!important;}
      html body:not(.sidebarCollapsed) main.dashboardShell{margin-left:230px!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .brandBox{height:78px!important;padding:0 10px 8px!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .brandBox img{width:124px!important;max-width:124px!important;height:auto!important;object-fit:contain!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .brandDivider{width:84%!important;margin:0 auto!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav{display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:4px!important;margin-top:8px!important;width:100%!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button,
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button.active,
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button:hover,
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button:focus{box-sizing:border-box!important;width:100%!important;min-width:0!important;max-width:100%!important;min-height:38px!important;height:38px!important;max-height:38px!important;margin:0!important;padding:0 12px 0 28px!important;border-radius:10px!important;display:block!important;align-items:unset!important;justify-content:unset!important;place-items:unset!important;text-align:left!important;white-space:nowrap!important;overflow:hidden!important;font-family:Arial,Helvetica,sans-serif!important;font-size:14px!important;font-weight:800!important;line-height:38px!important;letter-spacing:0!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button.active{background:linear-gradient(90deg,rgba(76,198,63,.72),rgba(76,198,63,.20))!important;color:#fff!important;border-left:3px solid #6cff4a!important;box-shadow:none!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button .menuIcon{display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;min-width:0!important;max-width:0!important;height:0!important;margin:0!important;padding:0!important;overflow:hidden!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button .menuText,
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button.active .menuText,
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button:hover .menuText,
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button:focus .menuText{display:block!important;position:static!important;width:100%!important;max-width:100%!important;height:38px!important;margin:0!important;padding:0!important;text-align:left!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;color:inherit!important;font:inherit!important;line-height:38px!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;box-shadow:none!important;}
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button[onclick*="alertas"],
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button[onclick*="alertas"].active,
      html body:not(.sidebarCollapsed) aside.sidebar .sideNav button[onclick*="alertas"] .menuText{box-shadow:none!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;}
      html body.sidebarCollapsed aside.sidebar{width:72px!important;min-width:72px!important;max-width:72px!important;padding:14px 8px!important;overflow:hidden!important;box-sizing:border-box!important;}
      html body.sidebarCollapsed main.dashboardShell{margin-left:72px!important;}
      html body.sidebarCollapsed aside.sidebar .brandBox{height:66px!important;padding:0!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;}
      html body.sidebarCollapsed aside.sidebar .brandBox img{width:48px!important;max-width:48px!important;height:auto!important;}
      html body.sidebarCollapsed aside.sidebar .brandDivider{display:none!important;}
      html body.sidebarCollapsed aside.sidebar .sideNav{display:flex!important;flex-direction:column!important;align-items:center!important;width:100%!important;gap:6px!important;}
      html body.sidebarCollapsed aside.sidebar .sideNav button,
      html body.sidebarCollapsed aside.sidebar .sideNav button.active{width:52px!important;min-width:52px!important;max-width:52px!important;height:40px!important;min-height:40px!important;max-height:40px!important;padding:0!important;margin:0!important;display:flex!important;align-items:center!important;justify-content:center!important;text-align:center!important;overflow:hidden!important;border-radius:12px!important;}
      html body.sidebarCollapsed aside.sidebar .sideNav button .menuText,
      html body.sidebarCollapsed aside.sidebar .adminBox div,
      html body.sidebarCollapsed aside.sidebar .logoutBtn{display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;min-width:0!important;max-width:0!important;overflow:hidden!important;}
      html body.sidebarCollapsed aside.sidebar .sideNav button .menuIcon{display:inline-flex!important;visibility:visible!important;opacity:1!important;width:30px!important;min-width:30px!important;max-width:30px!important;height:30px!important;align-items:center!important;justify-content:center!important;font-size:20px!important;line-height:1!important;}
    `;
  }
  function setVersion(){
    try{document.querySelectorAll('span,small,p,div,footer').forEach(el=>{if(el.childElementCount===0 && /Versi[oó]n\s+\d+\.\d+\.\d+/.test(el.textContent||'')){el.textContent=(el.textContent||'').replace(/Versi[oó]n\s+\d+\.\d+\.\d+/g,'Versión '+VERSION);}});}catch(e){}
  }
  function normalizeMenu(){
    try{
      ensureStyle();
      Object.entries(menuMap).forEach(([id,[icon,text]])=>{
        const btn=[...document.querySelectorAll('.sideNav button')].find(b=>(b.getAttribute('onclick')||'').includes(id));
        if(!btn)return;
        let ic=btn.querySelector('.menuIcon');
        let tx=btn.querySelector('.menuText');
        if(!ic || !tx || btn.childNodes.length!==2){btn.innerHTML='<span class="menuIcon" aria-hidden="true"></span><span class="menuText"></span>';ic=btn.querySelector('.menuIcon');tx=btn.querySelector('.menuText');}
        ic.textContent=icon; tx.textContent=text; btn.title=text;
        btn.querySelectorAll('.sideAlertBadge,.badgeCount,.alertBadge,.topAlertCount,#badgeAlertas,#alertCount').forEach(x=>x.remove());
      });
      setVersion();
    }catch(e){}
  ...
  function forceInline(){
    try{
      const expanded=!document.body.classList.contains('sidebarCollapsed');
      document.querySelectorAll('.sideNav button').forEach(btn=>{
        const tx=btn.querySelector('.menuText'); const ic=btn.querySelector('.menuIcon');
        if(expanded){
          btn.style.cssText += ';display:block!important;text-align:left!important;justify-content:unset!important;align-items:unset!important;padding-left:28px!important;line-height:38px!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;';
          if(tx) tx.style.cssText += ';display:block!important;text-align:left!important;width:100%!important;line-height:38px!important;white-space:nowrap!important;text-shadow:none!important;filter:none!important;animation:none!important;transform:none!important;';
          if(ic) ic.style.cssText += ';display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;';
        }else{
          btn.style.cssText += ';display:flex!important;align-items:center!important;justify-content:center!important;padding:0!important;text-align:center!important;';
          if(tx) tx.style.cssText += ';display:none!important;visibility:hidden!important;opacity:0!important;width:0!important;';
          if(ic) ic.style.cssText += ';display:inline-flex!important;visibility:visible!important;opacity:1!important;';
        }
      });
    }catch(e){}
  }
  const oldToggle=window.toggleSidebar;
  window.toggleSidebar=function(){ if(typeof oldToggle==='function') oldToggle.apply(this,arguments); else document.body.classList.toggle('sidebarCollapsed'); normalizeMenu(); forceInline(); };
  const oldTab=window.tab;
  if(typeof oldTab==='function'){window.tab=function(){const r=oldTab.apply(this,arguments); normalizeMenu(); forceInline(); return r;};}
  function run(){normalizeMenu(); forceInline();}
  document.addEventListener('DOMContentLoaded',()=>{run(); setTimeout(run,50); setTimeout(run,400);});
  window.addEventListener('load',()=>{run(); setTimeout(run,200);});
  setInterval(run,100);
  run();
})();
