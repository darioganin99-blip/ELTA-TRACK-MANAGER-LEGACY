...
const ELTA_APP_VERSION = "2.0.125";
...
/* ===== V2.0.125 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.125";
...
/* ===== V2.0.125 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='2.0.125';
...
/* ===== V2.0.125 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.125 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.125 ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.125";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.125 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.125 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.125 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.125';
...
/* ===== V2.0.125 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.125 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.125 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.125';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.125';});
})();


/* ===== V2.0.125 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.125";
...
/* ===== V2.0.125 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.125";
...
/* ===== V2.0.125 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.125 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.125';
...
/* ===== V2.0.125 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.125';
...
/* ===== V2.0.125 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.125';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.125 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.125';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.125 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.125 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.125 - Entrega por flota, compacta y con aduanas por pais destino ===== */
(function(){
  const VERSION='2.0.125';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.126 - ENTREGAS ESTABLE: banderas reales, filtros compactos, sin refrescos ===== */
(function(){
  const VERSION='2.0.126';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION; window.APP_VERSION=VERSION;
  const esc=v=>String(v??'').replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
  const S=v=>String(v??'').trim();
  const N=v=>S(v).normalize('NFD').replace(/[\u0300-\u036f]/g,'').toLowerCase();
  const arr=n=>Array.isArray(window[n])?window[n]:[];
  const val=(o,ks)=>{for(const k of ks){const v=o&&o[k]; if(v!==undefined&&v!==null&&S(v)!=='')return v;} return '';};
  const fmt=v=>{try{if(!v)return '-'; if(v&&v.toDate)v=v.toDate(); const d=new Date(v); if(isNaN(d))return S(v)||'-'; return d.toLocaleString('es-AR',{day:'2-digit',month:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit'});}catch(e){return S(v)||'-';}};
  const short=v=>{try{if(!v)return '-'; if(v&&v.toDate)v=v.toDate(); const d=new Date(v); if(isNaN(d))return S(v)||'-'; return d.toLocaleString('es-AR',{day:'2-digit',month:'2-digit',hour:'2-digit',minute:'2-digit'});}catch(e){return S(v)||'-';}};
  function setVersion(){
    try{window.ELTA_APP_VERSION=VERSION;window.APP_VERSION_V2=VERSION;window.APP_VERSION=VERSION;}catch(e){}
    document.querySelectorAll('span,small,p,div,footer').forEach(el=>{if(el.childElementCount===0&&/Versi[oó]n\s+\d+\.\d+\.\d+/i.test(el.textContent||'')){el.textContent=(el.textContent||'').replace(/Versi[oó]n\s+\d+\.\d+\.\d+/gi,'Versión '+VERSION);}});
    document.title=(document.title||'ELTA ITS').replace(/\d+\.\d+\.\d+/g,VERSION);
  }
  function country(v){
    const t=N(v);
    if(/\bbr\b/.test(t)||t.includes('brasil')||t.includes('brazil')||t.includes('sao paulo')||t.includes('curitiba'))return 'br';
    if(/\bpy\b/.test(t)||t.includes('paraguay')||t.includes('asuncion')||t.includes('puerto jose falcon')||t.includes('jose falcon')||t.includes('garden paraguay')||t.includes('deposito fiscal paraguay')||t.includes('clorinda'))return 'py';
    if(/\buy\b/.test(t)||t.includes('uruguay')||t.includes('montevideo')||t.includes('fray bentos')||t.includes('nordex'))return 'uy';
    ...
    if(/\bar\b/.test(t)||t.includes('argentina')||t.includes('clz')||t.includes('clc')||t.includes('zarate')||t.includes('cordoba')||t.includes('centro logistico')||t.includes('palomar'))return 'ar';
    return '';
  }
  const flag=c=>`<span class="eltaFlag eltaFlag-${['ar','cl','py','uy','br'].includes(c)?c:'ar'}" aria-label="${(c||'ar').toUpperCase()}"></span>`;
  function status(t,e){const s=N([val(t,['estado','status']),val(e,['estado','status'])].join(' ')); if(s.includes('final')||s.includes('cerr')||t?.closed||t?.cierre)return {txt:'CERRADO',cls:'done'}; if(s.includes('aduana'))return {txt:'EN ADUANA',cls:'customs'}; if(s.includes('program'))return {txt:'PROGRAMADO',cls:'planned'}; return {txt:'EN TRÁNSITO',cls:'open'};}
  function route(t){try{return typeof window.ruta==='function'?(window.ruta(t)||{}):(t?.ruta||t?.route||{});}catch(e){return t?.ruta||t?.route||{};}}
  function embNo(e){return S(val(e,['numero','embarque','idEmbarque','codigo'])||e?._docId||e?.id||'');}
  function trEmb(t){return S(val(t,['embarque','emb','embarqueId','numeroEmbarque']));}
  function trFleet(t){return S(val(t,['flota','fleet','usuario','user'])||t?.driver?.flota||'');}
  function lastTime(t){return val(t,['updatedAt','lastUpdate','lastReport','ultimoReporte','fechaActualizacion'])||t?.start?.time||t?.start||'';}
  ...
  async function readAduana(){if(Array.isArray(window.aduana)&&window.aduana.length)return window.aduana; try{if(typeof window.read==='function'){window.aduana=await window.read('aduana');return window.aduana;}}catch(e){} return window.aduana||[];}
  ...
  function ensureMenu(){
    const nav=document.querySelector('.sideNav'); if(!nav)return;
    let btn=nav.querySelector('button[data-menu-id="entrega"]')||[...nav.querySelectorAll('button')].find(b=>(b.getAttribute('onclick')||'').includes("tab('entrega')"));
    if(!btn){btn=document.createElement('button'); btn.type='button'; btn.dataset.menuId='entrega'; btn.setAttribute('onclick',"tab('entrega')"); btn.innerHTML='<span class="menuIcon">🚚</span><span class="menuText">Entregas</span>'; const emb=[...nav.querySelectorAll('button')].find(b=>(b.getAttribute('onclick')||'').includes("tab('embarques')")); emb&&emb.parentNode?emb.parentNode.insertBefore(btn,emb.nextSibling):nav.appendChild(btn);} 
    btn.dataset.menuId='entrega'; btn.setAttribute('onclick',"tab('entrega')");
    const mi=btn.querySelector('.menuIcon'); if(mi)mi.textContent='🚚'; const mt=btn.querySelector('.menuText'); if(mt)mt.textContent='Entregas';
  }
  function ensurePanel(){
    let sec=document.getElementById('entrega');
    if(!sec){sec=document.createElement('section'); sec.id='entrega'; sec.className='panel entregaPanel'; const emb=document.getElementById('embarques'); (emb&&emb.parentNode?emb.parentNode:document.querySelector('.dashboardShell')||document.body).insertBefore(sec,emb?emb.nextSibling:null);}
    if(!sec.querySelector('#entregaCards')){
      sec.innerHTML=`<div class="sectionTitle entregaHeader"><div><h2>Entregas</h2><p>Seguimiento de flotas en tránsito</p></div><button type="button" class="entregaRefreshBtn" onclick="window.renderEntrega&&window.renderEntrega(true)">Actualizar</button></div><div class="entregaToolbar glassPanel"><label><select id="entregaFiltroCliente"><option value="">Todos los clientes</option></select></label><label><select id="entregaFiltroEmbarque"><option value="">Embarque</option></select></label><label><select id="entregaFiltroDestino"><option value="">Todos los destinos</option></select></label><label><select id="entregaFiltroFlota"><option value="">Todas las flotas</option></select></label><label><select id="entregaFiltroEstado"><option value="">Todos</option><option value="en transito">En tránsito</option><option value="cerrado">Cerrado</option></select></label></div><div id="entregaCards" class="entregaCards"></div>`;
    }
  }
  function rows(){
    const em=new Map(); arr('embarques').forEach(e=>{const n=embNo(e); if(n)em.set(String(n),e);}); const groups=new Map();
    arr('trs').forEach(t=>{const fl=trFleet(t); if(!fl)return; const n=trEmb(t); const e=em.get(String(n))||{}; const rt=route(t)||{}; if(!groups.has(fl))groups.set(fl,{flota:fl,items:[]}); groups.get(fl).items.push({t,e,rt,n});});
    arr('embarques').forEach(e=>{const fl=S(val(e,['flota','flotas'])); if(!fl)return; fl.split(',').map(x=>x.trim()).filter(Boolean).forEach(f=>{if(!groups.has(f))groups.set(f,{flota:f,items:[]}); if(!groups.get(f).items.length)groups.get(f).items.push({t:{},e,rt:{},n:embNo(e)});});});
    return [...groups.values()].map(g=>{g.items.sort((a,b)=>String(lastTime(b.t)||val(b.e,['fecha','fechaHora','createdAt'])||b.n).localeCompare(String(lastTime(a.t)||val(a.e,['fecha','fechaHora','createdAt'])||a.n),'es',{numeric:true})); const it=g.items[0]||{}, t=it.t||{}, e=it.e||{}, rt=it.rt||{}; const nums=[...new Set(g.items.map(x=>x.n).filter(Boolean))]; return {flota:g.flota,embarques:nums,numero:S(it.n||embNo(e)),cliente:S(val(e,['cliente','client'])||rt.cliente||t.cliente),origen:S(val(e,['origen','origin'])||rt.origen||t.origen||'Centro Logístico Zárate'),destino:S(val(e,['destino','destination'])||rt.destino||t.destino||''),fecha:val(e,['fecha','fechaHora','createdAt','start'])||val(t,['fecha'])||t.start?.time||t.start||'',t,e,estado:status(t,e).txt};}).sort((a,b)=>String(a.flota).localeCompare(String(b.flota),'es',{numeric:true}));
  }
  function aduanaFor(row){const dc=country(row.destino); let ads=(window.aduana||[]).filter(a=>a&&a.activo!==false); const match=ads.filter(a=>dc&&country([a.pais,a.destino,a.country].join(' '))===dc); if(match.length)ads=match; return ads.sort((a,b)=>(Number(a.orden)||999)-(Number(b.orden)||999)).map(a=>S(a.nombre||a.name||a.id||a._docId||a.destino)).filter(Boolean);}
  function stages(row){let mid=aduanaFor(row); if(!mid.length){const d=country(row.destino); if(d==='cl')mid=['Uspallata','Los Andes']; else if(d==='py')mid=['Clorinda','Puerto José Falcón','Depósito Fiscal Paraguay']; else if(d==='uy')mid=['Gualeguaychú','Fray Bentos']; else mid=[];} return [row.origen||'Origen',...mid,row.destino||'Lugar de entrega'].filter(Boolean).slice(0,8);}
  function progress(row,st){const s=N([val(row.t,['estado','status']),val(row.e,['estado','status'])].join(' ')); if(s.includes('final')||s.includes('cerr'))return st.length-1; if(s.includes('aduana'))return Math.min(2,st.length-1); if(row.t&&Object.keys(row.t).length)return Math.min(1,st.length-1); return 0;}
  function fillFilters(allRows){
    const defs=[['entregaFiltroCliente','cliente','Todos los clientes'],['entregaFiltroEmbarque','embarques','Embarque'],['entregaFiltroDestino','destino','Todos los destinos'],['entregaFiltroFlota','flota','Todas las flotas']];
    defs.forEach(([id,key,label])=>{const sel=document.getElementById(id); if(!sel)return; const cur=sel.value; const vals=key==='embarques'?[...new Set(allRows.flatMap(r=>r.embarques||[]).filter(Boolean))]:[...new Set(allRows.map(r=>S(r[key])).filter(Boolean))]; vals.sort((a,b)=>String(a).localeCompare(String(b),'es',{numeric:true})); sel.innerHTML='<option value="">'+label+'</option>'+vals.map(v=>`<option value="${esc(v)}">${key==='embarques'?'Emb. ':''}${esc(v)}</option>`).join(''); if(vals.map(String).includes(cur))sel.value=cur; sel.onchange=()=>window.renderEntrega(false);});
  ...
  function flagCodes(row,st){let from=country(row.origen)||'ar'; let to=country(row.destino)||country(st[st.length-1]||''); if(!to||to===from){const all=N([row.destino,row.origen,st.join(' ')].join(' ')); if(all.includes('paraguay')||all.includes('falcon'))to='py'; else if(all.includes('chile')||all.includes('los andes')||all.includes('toyota chile'))to='cl'; else if(all.includes('uruguay')||all.includes('fray bentos'))to='uy'; else if(all.includes('brasil')||all.includes('brazil'))to='br'; else to='cl';} return {from,to};}
  function card(row,idx){const st=status(row.t,row.e), ss=stages(row), pi=progress(row,ss), pct=Math.max(0,Math.min(100,(pi/(Math.max(1,ss.length-1)))*100)); const upd=fmt(lastTime(row.t)||row.fecha), el=elapsed(row.fecha||lastTime(row.t)), next=ss[Math.min(pi+1,ss.length-1)]||'-'; const fc=flagCodes(row,ss); return `<article class="entregaCard ${idx%2?'entregaAlt':''}"><div class="entregaTop"><div class="entregaFleet"><span class="entregaFleetIcon"><img src="assets/camion-automobilero.png" alt=""></span><div><h3>Flota ${esc(row.flota)}</h3><span class="entregaStatus ${st.cls}">${esc(st.txt)}</span><small>Emb. ${esc(row.embarques.join(', ')||row.numero||'-')}</small></div></div><div class="entregaMeta"><span><i class="metaIcon">▣</i>Última act.</span><b>${esc(upd)}</b></div><div class="entregaMeta"><span><i class="metaIcon">◴</i>Tiempo transcurrido</span><b>${esc(el)}</b></div><div class="entregaMeta"><span><i class="metaIcon">⚑</i>Próximo hito</span><b>${esc(next)}</b></div><div class="entregaMeta"><span>Estado</span><b class="state ${st.cls}">${esc(st.txt)}</b></div><div class="entregaFlags">${flag(fc.from)}<i class="eltaFlagArrow">›</i>${flag(fc.to)}</div></div><div class="entregaTimeline"><div class="entregaLine"><i style="width:${pct}%"></i></div>${ss.map((s,i)=>`<div class="entregaStep ${i<=pi?'done':''} ${i===pi?'current':''} ${i===0?'first':''} ${i===ss.length-1?'last':''}" style="left:${(i/(Math.max(1,ss.length-1)))*100}%"><b>${esc(s)}</b><em>${esc(i===0?short(row.fecha):(i===pi?short(lastTime(row.t)||row.fecha):'-'))}</em></div>`).join('')}<div class="entregaVehicle" style="left:${pct}%"><img class="entregaCarrierImg" src="assets/camion-automobilero.png" alt="Camión automobilero"></div></div><div class="entregaBottom"><span><b>Actualizado:</b> ${esc(upd)}</span><span><b>Tiempo transcurrido:</b> ${esc(el)}</span><span><b>Próximo hito:</b> ${esc(next)}</span><span><b>Estado:</b> ${esc(st.txt)}</span></div></article>`;}
  window.renderEntrega=async function(force=false){ensureMenu();ensurePanel();injectCss();setVersion();await ensureData(force);let all=rows();fillFilters(all);const fc=N(document.getElementById('entregaFiltroCliente')?.value),fe=N(document.getElementById('entregaFiltroEmbarque')?.value),fd=N(document.getElementById('entregaFiltroDestino')?.value),ff=N(document.getElementById('entregaFiltroFlota')?.value),fs=N(document.getElementById('entregaFiltroEstado')?.value);let rs=all.filter(r=>(!fc||N(r.cliente)===fc)&&(!fe||(r.embarques||[]).some(e=>N(e)===fe))&&(!fd||N(r.destino)===fd)&&(!ff||N(r.flota)===ff)&&(!fs||(fs==='cerrado'?status(r.t,r.e).cls==='done':status(r.t,r.e).cls!=='done')));const box=document.getElementById('entregaCards'); if(box)box.innerHTML=rs.length?rs.map(card).join(''):'<div class="glassPanel entregaEmpty">No hay flotas para el filtro seleccionado.</div>';};
  function injectCss(){document.getElementById('entrega-v2097-css')?.remove(); document.getElementById('entregas-final-css')?.remove(); document.getElementById('entrega-v126-css')?.remove(); const css=document.createElement('style'); css.id='entrega-v126-css'; css.textContent=`
    #entrega .entregaHeader{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px}.entregaRefreshBtn{height:40px;border-radius:11px;border:1px solid rgba(76,175,67,.72);background:#1d6d2f;color:#d8ffd0;font-weight:900;padding:0 20px}.entregaToolbar{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:10px!important;padding:10px!important;margin-bottom:12px!important;border-radius:14px!important;background:rgba(15,31,48,.84)!important;border:1px solid rgba(148,163,184,.28)!important}.entregaToolbar label{display:block!important;font-size:0!important;color:transparent!important;margin:0!important}.entregaToolbar select{width:100%!important;height:42px!important;border-radius:11px!important;border:1px solid rgba(148,163,184,.36)!important;background:#223143!important;color:#f8fafc!important;padding:0 14px!important;font-size:15px!important;font-weight:850!important;outline:none!important}.entregaCards{display:flex;flex-direction:column;gap:12px}.entregaCard{border:1px solid rgba(148,163,184,.22);background:linear-gradient(135deg,rgba(7,22,37,.99),rgba(5,17,29,.96));border-radius:15px;padding:12px 16px;box-shadow:0 14px 28px rgba(0,0,0,.22)}.entregaCard.entregaAlt{background:linear-gradient(135deg,rgba(45,74,98,.99),rgba(29,55,78,.985))!important;border-color:rgba(190,210,232,.46)!important}.entregaTop{display:grid;grid-template-columns:1.18fr repeat(4,1fr) 140px;gap:12px;align-items:center}.entregaFleet{display:flex;align-items:center;gap:10px}.entregaFleetIcon{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:rgba(32,156,48,.18);border:1px solid rgba(82,255,96,.48);overflow:hidden}.entregaFleetIcon img{width:32px;height:auto}.entregaFleet h3{margin:0;font-size:20px;line-height:1;color:#f8fafc}.entregaFleet small{display:block;margin-top:4px;color:#cbd5e1;font-size:12px}.entregaStatus{display:inline-block;margin-top:4px;padding:4px 9px;border-radius:7px;font-size:11px;font-weight:900}.entregaStatus.open{background:#155d2d;color:#9dff7e}.entregaStatus.done{background:#475569;color:#e5e7eb}.entregaStatus.planned{background:#0b4a8f;color:#93c5fd}.entregaStatus.customs{background:#6b4e12;color:#fde68a}.entregaMeta{border-left:1px solid rgba(148,163,184,.18);padding-left:12px;min-width:0}.entregaMeta span{display:flex;align-items:center;justify-content:center;gap:7px;font-size:12px;color:#dbeafe;margin-bottom:4px}.entregaMeta b{display:block;text-align:center;color:#f8fafc;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.entregaMeta b.state.open{color:#7cff63;font-size:15px}.metaIcon{color:#7cff63;font-style:normal;font-size:16px;line-height:1}.entregaFlags{width:132px!important;height:50px!important;border-radius:14px!important;background:rgba(255,255,255,.045)!important;border:1px solid rgba(148,163,184,.32)!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:12px!important;justify-self:end!important;overflow:hidden!important}.eltaFlagArrow{font-style:normal!important;color:#7cff63!important;font-size:26px!important;font-weight:1000!important;line-height:1!important}.eltaFlag{position:relative!important;display:inline-block!important;width:34px!important;height:34px!important;border-radius:50%!important;border:1px solid rgba(255,255,255,.92)!important;overflow:hidden!important;box-shadow:0 2px 8px rgba(0,0,0,.42)!important;background:#fff}.eltaFlag-ar{background:linear-gradient(to bottom,#75bff2 0 33%,#fff 33% 66%,#75bff2 66% 100%)!important}.eltaFlag-ar:after{content:'';position:absolute;left:50%;top:50%;width:7px;height:7px;border-radius:50%;background:#f4b000;transform:translate(-50%,-50%)}.eltaFlag-cl{background:linear-gradient(to bottom,#fff 0 50%,#d92332 50% 100%)!important}.eltaFlag-cl:before{content:'';position:absolute;left:0;top:0;width:46%;height:50%;background:#1559b7}.eltaFlag-cl:after{content:'★';position:absolute;left:5px;top:2px;color:#fff;font-size:8px;line-height:1}.eltaFlag-py{background:linear-gradient(to bottom,#d92332 0 33%,#fff 33% 66%,#2452a3 66% 100%)!important}.eltaFlag-py:after{content:'';position:absolute;left:50%;top:50%;width:6px;height:6px;border-radius:50%;background:#d9b24c;transform:translate(-50%,-50%)}.eltaFlag-uy{background:repeating-linear-gradient(to bottom,#fff 0 4px,#fff 4px 7px,#4aa3df 7px 10px)!important}.eltaFlag-uy:after{content:'';position:absolute;left:7px;top:7px;width:7px;height:7px;border-radius:50%;background:#f4b000}.eltaFlag-br{background:#179b48!important}.eltaFlag-br:before{content:'';position:absolute;left:50%;top:50%;width:22px;height:22px;background:#ffd84b;transform:translate(-50%,-50%) rotate(45deg)}.eltaFlag-br:after{content:'';position:absolute;left:50%;top:50%;width:11px;height:11px;border-radius:50%;background:#21468b;transform:translate(-50%,-50%)}.entregaTimeline{position:relative;height:154px;margin-top:10px;padding:58px 68px 0;overflow:hidden;background:rgba(255,255,255,.012);border-radius:14px}.entregaLine{position:absolute;left:84px;right:84px;top:68px;height:3px;background:rgba(226,232,240,.78);border-radius:10px;overflow:visible}.entregaLine i{display:block;height:100%;background:linear-gradient(90deg,#22c55e,#84cc16,#f59e0b);border-radius:12px}.entregaStep{position:absolute;top:16px;transform:translateX(-50%);text-align:center;width:150px;z-index:3}.entregaStep.first{text-align:left}.entregaStep.last{text-align:right}.entregaStep b{display:block;color:#f8fafc;font-size:12px;line-height:1.12;text-transform:uppercase;text-shadow:0 1px 3px rgba(0,0,0,.55);white-space:normal}.entregaStep em{display:block;margin-top:44px;color:#cbd5e1;font-size:11px;font-style:normal;line-height:1.1}.entregaStep:after{content:'';position:absolute;left:50%;top:42px;width:14px;height:14px;border-radius:50%;transform:translateX(-50%);background:#f8fafc;border:5px solid #4b5568;box-shadow:0 0 0 2px rgba(15,23,42,.7)}.entregaStep.done:after{border-color:#4ade3f}.entregaStep.current:after{border-color:#4ade3f}.entregaVehicle{position:absolute;top:110px;transform:translateX(-50%);z-index:5;width:64px;height:28px;display:flex;align-items:center;justify-content:center;pointer-events:none}.entregaCarrierImg{width:62px!important;height:auto!important;display:block!important;filter:drop-shadow(0 3px 5px rgba(0,0,0,.45))}.entregaBottom{display:grid;grid-template-columns:1.1fr 1.1fr 1.1fr .8fr;gap:8px;margin-top:10px;padding:8px 12px;border-radius:10px;background:rgba(255,255,255,.035);border:1px solid rgba(148,163,184,.12);color:#dbeafe;font-size:12.5px}.entregaBottom span{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.entregaBottom b{color:#9dff7e}.entregaEmpty{padding:20px;color:#cbd5e1;font-weight:800}@media(max-width:1250px){.entregaToolbar{grid-template-columns:1fr 1fr!important}.entregaTop{grid-template-columns:1fr 1fr}.entregaBottom{grid-template-columns:1fr}.entregaTimeline{overflow:hidden}}
  `; document.head.appendChild(css);}
  const oldTab=window.tab; if(typeof oldTab==='function'){window.tab=function(id){ensureMenu(); const r=oldTab.apply(this,arguments); if(id==='entrega')setTimeout(()=>window.renderEntrega(false),20); setTimeout(setVersion,50); return r;};}
  const oldRefresh=window.refresh; if(typeof oldRefresh==='function'){window.refresh=async function(){const r=await oldRefresh.apply(this,arguments); if(document.getElementById('entrega')?.classList.contains('active'))window.renderEntrega(false); return r;};}
  document.addEventListener('DOMContentLoaded',()=>{ensureMenu();ensurePanel();injectCss();setVersion(); if(document.getElementById('entrega')?.classList.contains('active'))window.renderEntrega(false);});
  window.addEventListener('load',()=>{ensureMenu();ensurePanel();injectCss();setVersion(); if(document.getElementById('entrega')?.classList.contains('active'))window.renderEntrega(false);});
})();
