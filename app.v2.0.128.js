...
const ELTA_APP_VERSION = "2.0.128";
...
/* ===== V2.0.128 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2 = "2.0.128";
...
/* ===== V2.0.128 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V2.0.128 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 2.0.128 ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "2.0.128";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V2.0.128 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V2.0.128 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V2.0.128 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2039 = '2.0.128';
...
/* ===== V2.0.128 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V2.0.128 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== v2.0.128 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '2.0.128';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 2.0.128';});
})();


/* ===== V2.0.128 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "2.0.128";
...
/* ===== V2.0.128 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "2.0.128";
...
/* ===== V2.0.128 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V2.0.128 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='2.0.128';
...
/* ===== V2.0.128 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='2.0.128';
...
/* ===== V2.0.128 - Version lock definitivo ===== */
(function(){
  const VERSION = '2.0.128';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
...
/* ===== V2.0.128 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='2.0.128';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
...
/* ===== V2.0.128 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V2.0.128 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Entrega por flota, compacta y con aduanas por pais destino ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - Entrega: flota, banderas por pais, aduanas por destino, compacto ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - ajuste final SOLO Entregas: menú estable, timeline sin superposición ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
  function setV(){
...
/* ===== V2.0.128 - FIX FINAL VERSION Y MENU ESTABLE ===== */
(function(){
  const VERSION='2.0.128';
  ...
  setInterval(setVersionFinal,2000);
  window.setMenuFinalV209=setMenuFinal;
})();


/* ===== V2.0.128 - SOLO ENTREGAS: icono único y tarjeta según boceto ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - SOLO ENTREGAS: tarjeta compacta, camion reducido, banderas icono ===== */
(function(){
  const VERSION='2.0.128';
  function applyVersion(){
    window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO ENTREGAS: tarjeta igual al boceto, hitos sobre linea, camion chico, banderas reales ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - SOLO ENTREGAS: tarjeta reconstruida igual boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.128';
  function setVer(){
...
/* ===== V2.0.128 - CORRECCION FINAL SOLO ENTREGAS: tarjeta igual al boceto, sin tocar Embarques ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO Entregas: tarjeta compacta final y 2 banderas reales ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO Entregas: contenedor compacto, hitos sobre linea, sin checks, 2 banderas ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - SOLO Entregas: correccion real tarjeta compacta, banderas y timeline ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V2.0.128 - FIX FINAL SOLO ENTREGAS: banderas reales + iconos cabecera, sin tocar menu ni Embarques ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - FIX FINAL SOLO ENTREGAS: version unica + banderas reales visibles ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - FIX DEFINITIVO SOLO ENTREGAS: banderas reales dinamicas + version estable ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - SOLO ENTREGAS: banderas reales y contenedores alternados ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - FIX FINAL SOLO ENTREGAS: banderas visibles, version estable, contenedor alternado ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - FIX REAL SOLO ENTREGAS: banderas origen/destino + segundo contenedor mas claro ===== */
(function(){
  const VERSION='2.0.128';
...
/* ===== V2.0.128 - SOLO Entregas: banderas reales, filtros operativos, segundo contenedor mas claro ===== */
(function(){
  const VERSION='2.0.128';
  const norm=s=>String(s||'').normalize('NFD').replace(/[\u0300-\u036f]/g,'').toLowerCase();
  const EMOJI={ar:'🇦🇷',cl:'🇨🇱',py:'🇵🇾',uy:'🇺🇾',br:'🇧🇷'};
  function codeFromText(s){
    const t=norm(s);
    if(/\bbr\b/.test(t)||t.includes('brasil')||t.includes('brazil')||t.includes('sao paulo')||t.includes('curitiba')) return 'br';
    if(/\bpy\b/.test(t)||t.includes('paraguay')||t.includes('asuncion')||t.includes('puerto jose falcon')||t.includes('jose falcon')||t.includes('garden paraguay')||t.includes('deposito fiscal paraguay')) return 'py';
    if(/\buy\b/.test(t)||t.includes('uruguay')||t.includes('montevideo')||t.includes('nordex')||t.includes('fray bentos')) return 'uy';
    if(/\bcl\b/.test(t)||t.includes('chile')||t.includes('toyota chile')||t.includes('los andes')||t.includes('stli')||t.includes('libertadores')) return 'cl';
    if(/\bar\b/.test(t)||t.includes('argentina')||t.includes('clz')||t.includes('clc')||t.includes('zarate')||t.includes('zarate')||t.includes('cordoba')||t.includes('centro logistico')||t.includes('palomar')||t.includes('buenos aires')) return 'ar';
    return '';
  }
  function inferCountries(card){
    const names=[...card.querySelectorAll('.entregaStep b')].map(e=>(e.textContent||'').trim()).filter(Boolean);
    ...
    const all=(card.textContent||'')+' '+names.join(' ');
    let from=codeFromText(first)||'ar';
    let to=codeFromText(last);
    if(!to || to===from){
      const t=norm(all);
      if(t.includes('paraguay')||t.includes('puerto jose falcon')||t.includes('garden paraguay')||t.includes('deposito fiscal paraguay')) to='py';
      else if(t.includes('chile')||t.includes('toyota chile')||t.includes('los andes')||t.includes('stli')) to='cl';
      else if(t.includes('uruguay')||t.includes('montevideo')||t.includes('nordex')) to='uy';
      else if(t.includes('brasil')||t.includes('brazil')||t.includes('sao paulo')||t.includes('curitiba')) to='br';
      else to='cl';
  ...
  function injectCss(){
    if(document.getElementById('entregas-v20125-css')) return;
    const st=document.createElement('style'); st.id='entregas-v20125-css';
    st.textContent=`
      /* Filtros estilo tarjeta grande, sin etiquetas visibles */
      #entrega .entregaToolbar{display:grid!important;grid-template-columns:1.05fr 1.05fr 1.05fr 1.05fr .75fr!important;gap:12px!important;padding:14px!important;margin-bottom:14px!important;border-radius:14px!important;background:rgba(15,31,48,.84)!important;border:1px solid rgba(148,163,184,.28)!important;box-sizing:border-box!important}
      #entrega .entregaToolbar label{display:block!important;min-width:0!important;font-size:0!important;color:transparent!important;margin:0!important}
      #entrega .entregaToolbar select{width:100%!important;height:50px!important;border-radius:12px!important;border:1px solid rgba(148,163,184,.38)!important;background:#223143!important;color:#f8fafc!important;padding:0 18px!important;font-size:16px!important;font-weight:850!important;outline:none!important;box-sizing:border-box!important}
      #entrega .entregaToolbar select:focus{border-color:rgba(124,255,99,.55)!important;box-shadow:0 0 0 2px rgba(124,255,99,.12)!important}
      /* Segundo transito mas claro */
      #entrega .entregaCard:nth-child(odd){background:linear-gradient(135deg,rgba(7,22,37,.99),rgba(5,17,29,.96))!important;border-color:rgba(148,163,184,.20)!important}
      #entrega .entregaCard:nth-child(even){background:linear-gradient(135deg,rgba(39,67,90,.99),rgba(25,50,73,.985))!important;border-color:rgba(177,196,220,.44)!important;box-shadow:0 12px 24px rgba(0,0,0,.16)!important}
      /* Panel de banderas: solo origen > destino */
      #entrega .entregaFlags{width:138px!important;min-width:138px!important;max-width:138px!important;height:54px!important;min-height:54px!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:12px!important;padding:6px 10px!important;border-radius:14px!important;background:rgba(255,255,255,.045)!important;border:1px solid rgba(148,163,184,.32)!important;box-sizing:border-box!important;overflow:hidden!important;justify-self:end!important;font-size:0!important;line-height:0!important;color:transparent!important;visibility:visible!important;opacity:1!important}
      #entrega .entregaFlags > *{display:none!important}
      #entrega .entregaFlags::before{content:attr(data-flags)!important;display:block!important;color:#f8fafc!important;font-size:27px!important;line-height:1!important;letter-spacing:5px!important;white-space:nowrap!important;visibility:visible!important;opacity:1!important}
      #entrega .entregaFlags[data-flags='']::before{content:'🇦🇷  ›  🇨🇱'!important}
      @media(max-width:1250px){#entrega .entregaToolbar{grid-template-columns:1fr 1fr!important}}
    `;
    document.head.appendChild(st);
  }
  function renameFilterOptions(){
    const map={
      entregaFiltroCliente:'Todos los clientes',
      entregaFiltroEmbarque:'Embarque',
      entregaFiltroDestino:'Todos los destinos',
      entregaFiltroFlota:'Todas las flotas',
      entregaFiltroEstado:'Todos'
    };
    Object.entries(map).forEach(([id,label])=>{
      const sel=document.getElementById(id); if(!sel) return;
      const first=sel.querySelector('option[value=""]'); if(first) first.textContent=label;
      if(!sel.__entregaFilter125){
        sel.addEventListener('change',()=>{ if(typeof window.renderEntrega==='function') setTimeout(()=>window.renderEntrega(false),0); });
        sel.__entregaFilter125=true;
      }
    });
  }
  function renderFlags(){
    document.querySelectorAll('#entrega .entregaCard').forEach(card=>{
      const box=card.querySelector('.entregaFlags'); if(!box) return;
      const c=inferCountries(card);
      const flags=(EMOJI[c.from]||EMOJI.ar)+'  ›  '+(EMOJI[c.to]||EMOJI.cl);
      box.setAttribute('data-flags',flags);
      box.setAttribute('aria-label','Origen '+c.from.toUpperCase()+' destino '+c.to.toUpperCase());
      box.innerHTML='';
    });
  }
  function apply(){injectCss();setVersion();renameFilterOptions();renderFlags();}
  const oldRender=window.renderEntrega;
  if(typeof oldRender==='function' && !oldRender.__v20125){
    const wrapped=async function(){const r=await oldRender.apply(this,arguments); [0,50,150,450,1000].forEach(ms=>setTimeout(apply,ms)); return r;};
    wrapped.__v20125=true; window.renderEntrega=wrapped;
  }
  const oldTab=window.tab;
  if(typeof oldTab==='function' && !oldTab.__v20125){
    const wrapped=function(){const r=oldTab.apply(this,arguments); [50,200,700].forEach(ms=>setTimeout(apply,ms)); return r;};
    wrapped.__v20125=true; window.tab=wrapped;
  }
  function boot(){apply(); const target=document.getElementById('entregaCards')||document.getElementById('entrega'); if(target&&!target.__observerV20125){const mo=new MutationObserver(()=>setTimeout(apply,0)); mo.observe(target,{childList:true,subtree:true}); target.__observerV20125=mo;}}
  document.addEventListener('DOMContentLoaded',()=>{boot();[250,900,1800,3000].forEach(ms=>setTimeout(boot,ms));});
  window.addEventListener('load',()=>{boot();[400,1300,2600].forEach(ms=>setTimeout(boot,ms));});
  setTimeout(boot,100);
})();


/* ===== V2.0.128 - SOLO Entregas: banderas reales visibles + contenedor alternado, sin tocar menú ===== */
(function(){
  const VERSION='2.0.128';
  const norm=s=>String(s||'').normalize('NFD').replace(/[\u0300-\u036f]/g,'').toLowerCase();
  function country(s){
    const t=norm(s);
    if(/\bbr\b/.test(t)||t.includes('brasil')||t.includes('brazil')||t.includes('curitiba')||t.includes('sao paulo')) return 'br';
    if(/\bpy\b/.test(t)||t.includes('paraguay')||t.includes('asuncion')||t.includes('puerto jose falcon')||t.includes('jose falcon')||t.includes('deposito fiscal paraguay')||t.includes('garden paraguay')) return 'py';
    if(/\buy\b/.test(t)||t.includes('uruguay')||t.includes('montevideo')||t.includes('nordex')||t.includes('fray bentos')) return 'uy';
    if(/\bcl\b/.test(t)||t.includes('chile')||t.includes('toyota chile')||t.includes('los andes')||t.includes('stli')||t.includes('libertadores')) return 'cl';
    if(/\bar\b/.test(t)||t.includes('argentina')||t.includes('clz')||t.includes('clc')||t.includes('zarate')||t.includes('cordoba')||t.includes('centro logistico')||t.includes('buenos aires')) return 'ar';
    return '';
  }
  function infer(card){
    const steps=[...card.querySelectorAll('.entregaStep b')].map(x=>(x.textContent||'').trim()).filter(Boolean);
    const all=(card.textContent||'')+' '+steps.join(' ');
    let from=country(steps[0]||'')||'ar';
    let to=country(steps[steps.length-1]||'');
    if(!to || to===from){
      const t=norm(all);
      if(t.includes('paraguay')||t.includes('puerto jose falcon')||t.includes('garden paraguay')||t.includes('deposito fiscal paraguay')) to='py';
      ...
      else if(t.includes('brasil')||t.includes('brazil')||t.includes('curitiba')||t.includes('sao paulo')) to='br';
      else to='cl';
    }
    return {from,to};
  }
  function flag(c){
    c=(c||'ar').toLowerCase();
    if(!['ar','cl','py','uy','br'].includes(c)) c='ar';
    return '<span class="entregaFlagReal entregaFlagReal-'+c+'" aria-label="'+c.toUpperCase()+'"></span>';
  }
  function css(){
    const old=document.getElementById('entregas-v20127-final-css'); if(old) old.remove();
    const st=document.createElement('style'); st.id='entregas-v20127-final-css';
    st.textContent=`
      #entrega .entregaCard:nth-child(2n){background:linear-gradient(135deg,rgba(34,61,84,.98),rgba(22,47,70,.97))!important;border-color:rgba(185,205,230,.42)!important;box-shadow:0 12px 24px rgba(0,0,0,.16)!important}
      #entrega .entregaFlags{width:124px!important;min-width:124px!important;max-width:124px!important;height:48px!important;min-height:48px!important;padding:5px 10px!important;border-radius:14px!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:12px!important;background:rgba(255,255,255,.045)!important;border:1px solid rgba(148,163,184,.32)!important;box-sizing:border-box!important;overflow:hidden!important;justify-self:end!important;color:transparent!important;font-size:0!important;line-height:0!important;visibility:visible!important;opacity:1!important}
      #entrega .entregaFlags::before,#entrega .entregaFlags::after{content:none!important;display:none!important}
      #entrega .entregaFlags > *{display:none!important}
      #entrega .entregaFlags > .entregaFlagReal,#entrega .entregaFlags > .entregaFlagArrowReal{display:inline-block!important;visibility:visible!important;opacity:1!important;position:relative!important;flex:0 0 auto!important;box-sizing:border-box!important;background-clip:border-box!important}
      #entrega .entregaFlagArrowReal{color:#7cff63!important;font-size:28px!important;line-height:1!important;font-weight:1000!important;font-style:normal!important;background:transparent!important;border:0!important;width:auto!important;height:auto!important}
      #entrega .entregaFlagReal{width:32px!important;height:32px!important;border-radius:50%!important;border:1px solid rgba(255,255,255,.92)!important;overflow:hidden!important;box-shadow:0 2px 8px rgba(0,0,0,.42)!important;background:#fff!important}
      #entrega .entregaFlagReal-ar{background:linear-gradient(to bottom,#75bff2 0 33%,#fff 33% 66%,#75bff2 66% 100%)!important}
      #entrega .entregaFlagReal-ar:after{content:''!important;position:absolute!important;left:50%!important;top:50%!important;width:7px!important;height:7px!important;border-radius:50%!important;background:#f4b000!important;transform:translate(-50%,-50%)!important}
      #entrega .entregaFlagReal-cl{background:linear-gradient(to bottom,#fff 0 50%,#d92332 50% 100%)!important}
      #entrega .entregaFlagReal-cl:before{content:''!important;position:absolute!important;left:0!important;top:0!important;width:46%!important;height:50%!important;background:#1559b7!important}
      #entrega .entregaFlagReal-cl:after{content:'★'!important;position:absolute!important;left:5px!important;top:2px!important;color:#fff!important;font-size:8px!important;line-height:1!important}
      #entrega .entregaFlagReal-py{background:linear-gradient(to bottom,#d92332 0 33%,#fff 33% 66%,#2452a3 66% 100%)!important}
      #entrega .entregaFlagReal-py:after{content:''!important;position:absolute!important;left:50%!important;top:50%!important;width:6px!important;height:6px!important;border-radius:50%!important;background:#d9b24c!important;transform:translate(-50%,-50%)!important}
      #entrega .entregaFlagReal-uy{background:repeating-linear-gradient(to bottom,#fff 0 4px,#fff 4px 7px,#4aa3df 7px 10px)!important}
      #entrega .entregaFlagReal-uy:before{content:''!important;position:absolute!important;left:0!important;top:0!important;width:46%!important;height:46%!important;background:#fff!important}
      #entrega .entregaFlagReal-uy:after{content:''!important;position:absolute!important;left:7px!important;top:7px!important;width:7px!important;height:7px!important;border-radius:50%!important;background:#f4b000!important}
      #entrega .entregaFlagReal-br{background:#179b48!important}
      #entrega .entregaFlagReal-br:before{content:''!important;position:absolute!important;left:50%!important;top:50%!important;width:22px!important;height:22px!important;background:#ffd84b!important;transform:translate(-50%,-50%) rotate(45deg)!important}
      #entrega .entregaFlagReal-br:after{content:''!important;position:absolute!important;left:50%!important;top:50%!important;width:11px!important;height:11px!important;border-radius:50%!important;background:#21468b!important;transform:translate(-50%,-50%)!important}
    `;
    document.head.appendChild(st);
  }
  function setVersion(){
  ...
  function render(){
    ...
    document.querySelectorAll('#entrega .entregaCard').forEach(card=>{
      const box=card.querySelector('.entregaFlags'); if(!box) return;
      const c=infer(card);
      box.innerHTML=flag(c.from)+'<i class="entregaFlagArrowReal" aria-hidden="true">›</i>'+flag(c.to);
      box.setAttribute('aria-label','Origen '+c.from.toUpperCase()+' destino '+c.to.toUpperCase());
    });
  }
  const oldRender=window.renderEntrega;
  if(typeof oldRender==='function' && !oldRender.__v20127){
    const wrapped=async function(){const r=await oldRender.apply(this,arguments); [0,60,180,500,1200].forEach(ms=>setTimeout(render,ms)); return r;};
    wrapped.__v20127=true; window.renderEntrega=wrapped;
  }
  const oldTab=window.tab;
  if(typeof oldTab==='function' && !oldTab.__v20127){
    const wrapped=function(){const r=oldTab.apply(this,arguments); [80,220,700,1500].forEach(ms=>setTimeout(render,ms)); return r;};
    wrapped.__v20127=true; window.tab=wrapped;
  }
  function boot(){render(); const t=document.getElementById('entregaCards')||document.getElementById('entrega'); if(t&&!t.__observerV20127){const mo=new MutationObserver(()=>setTimeout(render,0)); mo.observe(t,{childList:true,subtree:true}); t.__observerV20127=mo;}}
  document.addEventListener('DOMContentLoaded',()=>{boot();[300,1000,2200].forEach(ms=>setTimeout(boot,ms));});
  window.addEventListener('load',()=>{boot();[500,1500,3000].forEach(ms=>setTimeout(boot,ms));});
  setTimeout(boot,100);
})();

/* ===== V2.0.128 - FIX FINAL ENTREGAS: banderas, filtros estables, version ===== */
(function(){
  const VERSION='2.0.128';
  window.ELTA_APP_VERSION=VERSION; window.APP_VERSION_V2=VERSION;
  const esc=v=>String(v??'').replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
  ...
  const L=v=>S(v).toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,'');
  const arr=n=>Array.isArray(window[n])?window[n]:[];
  const field=(o,ks)=>{for(const k of ks){const v=o&&o[k]; if(v!==undefined&&v!==null&&S(v)!=='')return v;} return '';};
  ...
  function country(v){const s=L(v); if(/\b(chile|cl|stli|santiago|pudahuel|los andes|libertadores)\b/.test(s))return 'CL'; if(/\b(paraguay|py|asuncion|asunción|clorinda|falcon|falcón|garden)\b/.test(s))return 'PY'; if(/\b(uruguay|uy|montevideo|fray bentos|gualeguaychu|gualeguaychú)\b/.test(s))return 'UY'; if(/\b(brasil|br|brazil|sao paulo|san pablo|curitiba)\b/.test(s))return 'BR'; if(/\b(argentina|ar|zarate|zárate|cordoba|córdoba|clz|clc|fca|palomar|buenos aires)\b/.test(s))return 'AR'; return '';}
  const FLAGS={AR:'🇦🇷',CL:'🇨🇱',PY:'🇵🇾',UY:'🇺🇾',BR:'🇧🇷'};
  function flag(code){return FLAGS[code]||'🏳️';}
  function fmt(v){try{if(!v)return '-'; if(v && v.toDate)v=v.toDate(); const d=new Date(v); if(isNaN(d))return S(v)||'-'; return d.toLocaleString('es-AR',{day:'2-digit',month:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit'});}catch(e){return S(v)||'-';}}
  function fmtShort(v){try{if(!v)return '-'; if(v && v.toDate)v=v.toDate(); const d=new Date(v); if(isNaN(d))return S(v)||'-'; return d.toLocaleString('es-AR',{day:'2-digit',month:'2-digit',hour:'2-digit',minute:'2-digit'});}catch(e){return S(v)||'-';}}
  function elapsed(v){try{if(!v)return '-'; if(v&&v.toDate)v=v.toDate(); const d=new Date(v); if(isNaN(d))return '-'; const ms=Date.now()-d.getTime(); if(ms<0)return '-'; const h=Math.floor(ms/3600000), dd=Math.floor(h/24), hh=h%24, mm=Math.floor((ms%3600000)/60000); return (dd?dd+' d ':'')+hh+' h '+mm+' m';}catch(e){return '-';}}
  function id(o){return S(o?._docId||o?.id||o?.numero||o?.embarque||'');}
  function embNo(e){return S(field(e,['numero','embarque','idEmbarque','codigo'])||id(e));}
  function trEmb(t){return S(field(t,['embarque','emb','embarqueId','numeroEmbarque']));}
  function trFleet(t){return S(field(t,['flota','fleet','usuario','user'])||t?.driver?.flota||'');}
  function lastTime(t){return field(t,['updatedAt','lastUpdate','lastReport','ultimoReporte','fechaActualizacion'])||t?.start?.time||t?.start||'';}
  function embDate(e){return field(e,['fecha','fechaHora','createdAt','start']);}
  function status(t,e){const s=L([field(t,['estado','status']),field(e,['estado','status'])].join(' ')); if(s.includes('final')||s.includes('cerr')||t?.closed||t?.cierre)return {txt:'CERRADO',cls:'done'}; if(s.includes('aduana'))return {txt:'EN ADUANA',cls:'customs'}; if(s.includes('program'))return {txt:'PROGRAMADO',cls:'planned'}; return {txt:'EN TRÁNSITO',cls:'open'};}
  function getRoute(t){try{if(typeof window.ruta==='function')return window.ruta(t)||{};}catch(e){} return t?.ruta||t?.route||{};}
  function rows(){const em=new Map(); arr('embarques').forEach(e=>{const n=embNo(e); if(n)em.set(String(n),e);}); const groups=new Map(); arr('trs').forEach(t=>{const fl=trFleet(t); if(!fl)return; const n=trEmb(t), e=em.get(String(n))||{}, rt=getRoute(t); if(!groups.has(fl))groups.set(fl,{flota:fl,items:[]}); groups.get(fl).items.push({t,e,rt,n});}); arr('embarques').forEach(e=>{const fl=S(field(e,['flota','flotas'])); if(!fl)return; fl.split(',').map(x=>x.trim()).filter(Boolean).forEach(f=>{if(!groups.has(f))groups.set(f,{flota:f,items:[]}); if(!groups.get(f).items.length)groups.get(f).items.push({t:{},e,rt:{},n:embNo(e)});});}); return [...groups.values()].map(g=>{g.items.sort((a,b)=>String(lastTime(b.t)||embDate(b.e)||b.n).localeCompare(String(lastTime(a.t)||embDate(a.e)||a.n),'es',{numeric:true})); const it=g.items[0]||{}, t=it.t||{}, e=it.e||{}, rt=it.rt||{}; const nums=[...new Set(g.items.map(x=>x.n).filter(Boolean))]; return {flota:g.flota, embarques:nums, numero:S(it.n||embNo(e)), cliente:S(field(e,['cliente','client'])||rt.cliente||t.cliente), origen:S(field(e,['origen','origin'])||rt.origen||t.origen||'Centro Logístico Zárate'), destino:S(field(e,['destino','destination'])||rt.destino||t.destino||''), fecha:embDate(e)||field(t,['fecha'])||t.start?.time||t.start||'', t,e};}).sort((a,b)=>String(a.flota).localeCompare(String(b.flota),'es',{numeric:true}));}
  function stages(r){const dc=country(r.destino); let mid=[]; if(dc==='CL')mid=['Uspallata','Los Andes']; else if(dc==='PY')mid=['Clorinda','Puerto José Falcón','Depósito Fiscal Paraguay']; else if(dc==='UY')mid=['Gualeguaychú','Fray Bentos']; else if(dc==='BR')mid=['Uruguayana','São Paulo']; return [r.origen||'Origen',...mid,r.destino||'Lugar de entrega'].filter(Boolean).slice(0,8);}
  function progress(r,st){const s=L([field(r.t,['estado','status']),field(r.e,['estado','status'])].join(' ')); if(s.includes('final')||s.includes('cerr'))return st.length-1; if(s.includes('aduana'))return Math.min(2,st.length-1); if(r.t&&Object.keys(r.t).length)return Math.min(1,st.length-1); return 0;}
  function ensureSection(){let sec=document.getElementById('entrega'); if(!sec)return null; let toolbar=sec.querySelector('.entregaToolbar'); if(!toolbar){const title=sec.querySelector('.sectionTitle')||sec.firstElementChild; toolbar=document.createElement('div'); toolbar.className='entregaToolbar glassPanel'; toolbar.innerHTML='<select id="entregaFiltroCliente"><option value="">Todos los clientes</option></select><select id="entregaFiltroEmbarque"><option value="">Embarque</option></select><select id="entregaFiltroDestino"><option value="">Todos los destinos</option></select><select id="entregaFiltroFlota"><option value="">Todas las flotas</option></select><select id="entregaFiltroEstado"><option value="">Todos</option><option value="open">En tránsito</option><option value="done">Cerrado</option></select>'; title?title.insertAdjacentElement('afterend',toolbar):sec.prepend(toolbar);} let box=sec.querySelector('#entregaCards'); if(!box){box=document.createElement('div'); box.id='entregaCards'; box.className='entregaCards'; sec.appendChild(box);} return sec;}
  function fillFilters(rs){const defs=[['entregaFiltroCliente','cliente','Todos los clientes'],['entregaFiltroEmbarque','embarques','Embarque'],['entregaFiltroDestino','destino','Todos los destinos'],['entregaFiltroFlota','flota','Todas las flotas']]; defs.forEach(([idn,key,label])=>{const sel=document.getElementById(idn); if(!sel)return; const cur=sel.value; let vals=key==='embarques'?[...new Set(rs.flatMap(r=>r.embarques||[]).filter(Boolean))]:[...new Set(rs.map(r=>S(r[key])).filter(Boolean))]; vals.sort((a,b)=>String(a).localeCompare(String(b),'es',{numeric:true})); sel.innerHTML=`<option value="">${label}</option>`+vals.map(v=>`<option value="${esc(v)}">${esc(v)}</option>`).join(''); sel.value=vals.includes(cur)?cur:''; sel.onchange=()=>window.renderEntrega(false);}); const es=document.getElementById('entregaFiltroEstado'); if(es){const cur=es.value; es.innerHTML='<option value="">Todos</option><option value="open">En tránsito</option><option value="done">Cerrado</option>'; es.value=cur; es.onchange=()=>window.renderEntrega(false);}}
  function card(r,idx){const st=status(r.t,r.e), ss=stages(r), pi=progress(r,ss), pct=Math.max(0,Math.min(100,(pi/(Math.max(1,ss.length-1)))*100)); const upd=fmt(lastTime(r.t)||r.fecha), el=elapsed(r.fecha||lastTime(r.t)), next=ss[Math.min(pi+1,ss.length-1)]||'-'; const fc=country(r.origen)||'AR', tc=country(r.destino)||'CL'; return `<article class="entregaCard ${idx%2?'alt':''}" data-cliente="${esc(L(r.cliente))}" data-embarque="${esc(L((r.embarques||[]).join(' ')))}" data-destino="${esc(L(r.destino))}" data-flota="${esc(L(r.flota))}" data-status="${st.cls}"><div class="entregaTop"><div class="entregaFleet"><span class="entregaFleetIcon"><img src="assets/camion-automobilero.png" alt=""></span><div><h3>Flota ${esc(r.flota)}</h3><span class="entregaStatus ${st.cls}">${esc(st.txt)}</span><small>Emb. ${esc(r.embarques.join(', ')||r.numero||'-')}</small></div></div><div class="entregaMeta"><span><i>🗓️</i> Última act.</span><b>${esc(upd)}</b></div><div class="entregaMeta"><span><i>⏱️</i> Tiempo transcurrido</span><b>${esc(el)}</b></div><div class="entregaMeta"><span><i>⚑</i> Próximo hito</span><b>${esc(next)}</b></div><div class="entregaMeta"><span>Estado</span><b class="state ${st.cls}">${esc(st.txt)}</b></div><div class="entregaFlags" aria-label="Origen ${fc} destino ${tc}"><span class="flagIcon">${flag(fc)}</span><i>›</i><span class="flagIcon">${flag(tc)}</span></div></div><div class="entregaTimeline"><div class="entregaLine"><i style="width:${pct}%"></i></div>${ss.map((s,i)=>`<div class="entregaStep ${i<=pi?'done':''} ${i===pi?'current':''} ${i===0?'first':''} ${i===ss.length-1?'last':''}" style="left:${(i/(Math.max(1,ss.length-1)))*100}%"><b>${esc(s)}</b><em>${esc(i===0?fmtShort(r.fecha):(i===pi?fmtShort(lastTime(r.t)||r.fecha):'-'))}</em></div>`).join('')}<div class="entregaVehicle" style="left:${pct}%"><img class="entregaCarrierImg" src="assets/camion-automobilero.png" alt="Camión automobilero"></div></div><div class="entregaBottom"><span><b>Actualizado:</b> ${esc(upd)}</span><span><b>Tiempo transcurrido:</b> ${esc(el)}</span><span><b>Próximo hito:</b> ${esc(next)}</span><span><b>Estado:</b> ${esc(st.txt)}</span></div></article>`;}
  async function maybeRefresh(force){if(force&&typeof window.refresh==='function'&&!window.__entregaRefreshing){try{window.__entregaRefreshing=true; await window.refresh();}catch(e){}finally{window.__entregaRefreshing=false;}}}
  window.renderEntrega=async function(force=false){const sec=ensureSection(); if(!sec)return; setVersion(); await maybeRefresh(force); let rs=rows(); fillFilters(rs); const fc=L(document.getElementById('entregaFiltroCliente')?.value), fe=L(document.getElementById('entregaFiltroEmbarque')?.value), fd=L(document.getElementById('entregaFiltroDestino')?.value), ff=L(document.getElementById('entregaFiltroFlota')?.value), fs=document.getElementById('entregaFiltroEstado')?.value; rs=rs.filter(r=>(!fc||L(r.cliente)===fc)&&(!fe||(r.embarques||[]).some(e=>L(e)===fe))&&(!fd||L(r.destino)===fd)&&(!ff||L(r.flota)===ff)&&(!fs||status(r.t,r.e).cls===fs)); const box=document.getElementById('entregaCards'); if(box)box.innerHTML=rs.length?rs.map(card).join(''):'<div class="glassPanel entregaEmpty">No hay flotas para el filtro seleccionado.</div>'; };
  function inject(){if(document.getElementById('entrega-v128-final-css'))return; const css=document.createElement('style'); css.id='entrega-v128-final-css'; css.textContent=`#entrega .entregaToolbar{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:10px!important;padding:10px 12px!important;margin:10px 0 14px!important;border-radius:14px!important}#entrega .entregaToolbar label{display:contents!important}#entrega .entregaToolbar select{height:42px!important;border-radius:12px!important;border:1px solid rgba(148,163,184,.35)!important;background:#1d2b3b!important;color:#f8fafc!important;padding:0 16px!important;font-size:16px!important;font-weight:850!important;min-width:0!important}#entrega .entregaCards{display:flex!important;flex-direction:column!important;gap:10px!important}#entrega .entregaCard{border:1px solid rgba(148,163,184,.24)!important;background:linear-gradient(135deg,rgba(9,22,35,.98),rgba(6,17,29,.96))!important;border-radius:14px!important;padding:12px 16px!important;box-shadow:0 14px 28px rgba(0,0,0,.22)!important}#entrega .entregaCard.alt{background:linear-gradient(135deg,rgba(27,48,68,.99),rgba(19,36,54,.96))!important;border-color:rgba(148,180,210,.34)!important}#entrega .entregaTop{display:grid!important;grid-template-columns:1.05fr repeat(4,1fr) .7fr!important;gap:10px!important;align-items:center!important}#entrega .entregaFleet{display:flex!important;align-items:center!important;gap:10px!important}#entrega .entregaFleetIcon{width:40px!important;height:40px!important;border-radius:50%!important;display:grid!important;place-items:center!important;background:rgba(32,156,48,.22)!important;border:1px solid rgba(82,255,96,.42)!important;overflow:hidden!important}#entrega .entregaFleetIcon img{width:34px!important;height:auto!important}#entrega .entregaFleet h3{margin:0!important;font-size:19px!important;line-height:1!important;color:#f8fafc!important}#entrega .entregaFleet small{display:block!important;margin-top:5px!important;color:#cbd5e1!important;font-size:11px!important}.entregaStatus{display:inline-block!important;margin-top:4px!important;padding:3px 9px!important;border-radius:7px!important;font-size:10px!important;font-weight:900!important}.entregaStatus.open{background:#155d2d!important;color:#9dff7e!important}.entregaMeta{border-left:1px solid rgba(148,163,184,.18)!important;padding-left:10px!important;min-width:0!important}.entregaMeta span{display:flex!important;gap:6px!important;align-items:center!important;font-size:11px!important;color:#dbeafe!important;margin-bottom:3px!important}.entregaMeta b{display:block!important;color:#f8fafc!important;font-size:12px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}.entregaMeta b.state.open{color:#7cff63!important}.entregaFlags{height:54px!important;min-width:110px!important;border:1px solid rgba(148,163,184,.28)!important;border-radius:14px!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:12px!important;background:rgba(255,255,255,.025)!important}.entregaFlags .flagIcon{font-size:28px!important;line-height:1!important;display:block!important}.entregaFlags i{font-style:normal!important;font-size:26px!important;font-weight:900!important;color:#88ff5f!important;line-height:1!important}.entregaTimeline{position:relative!important;height:78px!important;margin-top:8px!important;padding:8px 28px 0!important;overflow:hidden!important;background:rgba(5,15,26,.18)!important;border-radius:12px!important}.entregaLine{position:absolute!important;left:28px!important;right:28px!important;top:31px!important;height:3px!important;background:rgba(226,232,240,.78)!important;border-radius:10px!important;overflow:visible!important}.entregaLine i{display:block!important;height:100%!important;background:linear-gradient(90deg,#22c55e,#84cc16,#f59e0b)!important;border-radius:10px!important}.entregaStep{position:absolute!important;top:8px!important;transform:translateX(-50%)!important;text-align:center!important;width:130px!important;z-index:3!important}.entregaStep.first{transform:none!important;text-align:left!important}.entregaStep.last{transform:translateX(-100%)!important;text-align:right!important}.entregaStep b{display:block!important;margin:0 0 27px!important;color:#f8fafc!important;font-size:10.5px!important;line-height:1.1!important;text-transform:uppercase!important}.entregaStep em{display:block!important;color:#cbd5e1!important;font-size:10.5px!important;font-style:normal!important}.entregaStep::after{content:''!important;position:absolute!important;left:50%!important;top:23px!important;width:12px!important;height:12px!important;border-radius:50%!important;transform:translateX(-50%)!important;border:3px solid rgba(15,23,42,.95)!important;background:#e5e7eb!important;box-shadow:0 0 0 2px rgba(226,232,240,.65)!important}.entregaStep.first::after{left:12px!important;transform:none!important}.entregaStep.last::after{left:auto!important;right:12px!important;transform:none!important}.entregaStep.done::after{background:#74ff5f!important;box-shadow:0 0 0 2px rgba(34,197,94,.82)!important}.entregaVehicle{position:absolute!important;top:51px!important;transform:translateX(-50%)!important;z-index:5!important}.entregaCarrierImg{width:54px!important;height:auto!important;display:block!important;filter:drop-shadow(0 5px 7px rgba(0,0,0,.5))!important}.entregaBottom{display:grid!important;grid-template-columns:1.1fr 1.1fr 1.1fr .8fr!important;gap:8px!important;margin-top:8px!important;padding:7px 10px!important;border-radius:10px!important;background:rgba(255,255,255,.035)!important;border:1px solid rgba(148,163,184,.12)!important;color:#dbeafe!important;font-size:12px!important}.entregaBottom b{color:#9dff7e!important}@media(max-width:1250px){#entrega .entregaToolbar{grid-template-columns:1fr 1fr!important}#entrega .entregaTop{grid-template-columns:1fr 1fr!important}#entrega .entregaBottom{grid-template-columns:1fr!important}}`; document.head.appendChild(css);}
  const oldTab=window.tab; if(typeof oldTab==='function'&&!oldTab.__v2128){const f=function(id){const r=oldTab.apply(this,arguments); inject(); setVersion(); if(id==='entrega')setTimeout(()=>window.renderEntrega(false),50); return r;}; f.__v2128=true; window.tab=f;}
  document.addEventListener('DOMContentLoaded',()=>{inject();setVersion();if(document.getElementById('entrega')?.classList.contains('active'))window.renderEntrega(false);}); window.addEventListener('load',()=>{inject();setVersion();if(document.getElementById('entrega')?.classList.contains('active'))window.renderEntrega(false);}); setTimeout(()=>{inject();setVersion();},400);
})();
